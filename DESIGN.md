...
- **Nothing entered anywhere** collapses further, to a quiet text link (`Start a draft →`). Ten dashed empty rings as permanent chrome on every page, for a visitor who has never touched the feature, would be a worse default than an invitation.
