    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/60 p-4" onClick={onClose}>
      ...
      >
        ...
        <div className="mb-4 flex flex-wrap gap-3 text-[11px] text-muted">
          <span className="inline-flex items-center gap-1.5"><Swatch className="bg-under" />Underrated</span>
          <span className="inline-flex items-center gap-1.5"><Swatch className="bg-premium" />Overrated</span>
          <span className="inline-flex items-center gap-1.5"><Swatch className="bg-gold" />Heuristic score</span>
        </div>
        <ul className="flex flex-col gap-2 text-sm text-muted">
          ...
          <li>The <b className="text-ink">Items</b> shop rates every item <b className="text-under">Underrated</b> / <b className="text-ink">Fair</b> / <b className="text-premium">Overrated</b> by gold efficiency, with filters.</li>
