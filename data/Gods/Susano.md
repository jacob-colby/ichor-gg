...
- slot: Passive
  ...
  - At 3 stacks, enemies also take increased damage
...
- slot: 1st Ability
  ...
  - This ability Cooldown is increased by 1 second for each additional attack used
  - Each attack of Storm Kata can trigger ability item effects
  - The Dash passes through and damages all enemies
  ...
  - 'Strike Range: 4.8 meters'
  - 'Strike Cone Angle: 60 degrees'
  - 'Spin Radius: 4.8 meters'
  - 'Dash Range: 7 meters'
...
- slot: 3rd Ability
  ...
  - You can reactive this ability to Teleport to the whirlwind
  - The whirlwind will travel with the enemy hit
  - This ability Cooldown is reduced by 4 seconds when Teleporting to an enemy
...
- slot: Ultimate
  ...
  - 100.0
  details:
  - After reaching full size, the typhoon is launched in the direction you are facing,
    dealing Physical Damage and Knocking Up enemies
  - Reactivate this ability to fire the typhoon at its current size, dealing reduced
    damage
  - This ability automatically refires after 2 seconds
