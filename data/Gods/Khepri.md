...
- slot: Basic Attack
  ...
  description: 'Khepri Notes: Deal Magical Damage to an enemy in front of you Damage
...
- slot: Passive
  ...
  description: 'PERIODICALLY SHIELD ALLIES Notes: Every 5 seconds apply a Health Shield
    to yourself and nearby allies Health Shield : 2% Max Health Max Shield Health
    : 10% Max Health Shield Duration : 15 seconds Expand Ability Video'
- slot: 1st Ability
  name: Abduct
  cooldown:
  - 14.0
  ...
  - 'Cooldown: 14 seconds'
  - 'Cost: 60 mana'
  description: 'DASH, GRAB AND PULL Notes: Dash forward, Grabbing , and Pulling the
    first enemy god hit Damage : 80 | 130 | 180 | 230 | 280 Damage Scaling : 40% Intelligence
    Silence and Grab Duration : 1.5 | 1.6 | 1.7 | 1.8 | 1.9 seconds Protections :
    25 | 35 | 45 | 55 | 65 Range : 6.4 meters Cooldown : 14 seconds Cost : 60 mana
...
- slot: 2nd Ability
  ...
  description: 'AREA DAMAGE, PROTECT Notes: Roll the sun forward, setting ablaze all
    enemies it touches Damage Per Tick : 8 | 12 | 16 | 20 | 24 Damage Scaling Per
    Tick : 5% Intelligence Physical Protections Reduced : 5 | 10 | 15 | 20 | 25% Debuff
    Duration : 4 seconds Damage Mitigation : 10 | 15 | 20 | 25 | 30% Buff Duration
    : 4 seconds Range : 11.2 meters Projectile Radius : 1.6 meters Explosion Radius
    : 3.7 meters Cooldown : 12 seconds Cost : 50 | 60 | 70 | 80 | 90 mana Expand Ability
    Video'
- slot: 3rd Ability
  name: Solar Flare
  cooldown:
  ...
  description: 'AREA DAMAGE ROOT Call down the sun''s ire, dealing Magical Damage
    and Rooting enemies in an area Damage : 60 | 115 | 170 | 225 | 280 Damage Scaling
    : 30% Intelligence Root Duration : 1.25 | 1.3 | 1.35 | 1.4 | 1.45 seconds Range
    : 8.8 meters Radius : 2.4 meters Cooldown : 13 | 12.5 | 12 | 11.5 | 11 seconds
...
- slot: Ultimate
  ...
  description: 'BLESS ALLY, REVIVE ON DEATH Notes: Blessed allies receive Strength
    , Intelligence , and Movement Speed Bless an allied god for 5 seconds. If the
    blessed ally would die while blessed, they are instead revived at Khepri''s location
    Strength and Intelligence : 25 | 32.5 | 40 | 47.5 | 55 Movement Speed : 20 | 22.5
    | 25 | 27.5 | 30% Buff Duration : 5 seconds Revived Health : 20 | 25 | 30 | 35
    | 40% Permanent Protections Buff : 2 Per Revive Range : 8.8 meters Radius : 2.4
    meters Cooldown : 110 seconds Cost : 80 | 90 | 100 | 110 | 120 meters Expand Ability
    Video'
aspects:
