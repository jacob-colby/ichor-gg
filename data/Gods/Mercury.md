...
- slot: Passive
  ...
  details:
  - You also gain additional Strength equal to 25% of your Movement Speed from items
    or abilities
...
- slot: 1st Ability
  ...
  - 50.0
  details:
  - This ability can Critically Hit, apply Ability Item effects, and apply Attack
    Item effects
  - 'Damage: 80 | 115 | 150 | 185 | 220'
  - 'Damage Scaling: 70% Basic Attack Damage'
  - 'Range: 7.68 meters'
...
- slot: 2nd Ability
  ...
  - 80.0
  details:
  - Passively gain increased Movement Speed as this ability is ranked up
...
- slot: 3rd Ability
  ...
  - 'Minion Damage: 70 | 115 | 160 | 205 | 250'
  - 'Minion Damage Scaling: 64% Strength'
...
- slot: Ultimate
  ...
  details:
  - The Spin is treated as a Stun
  - You are CC Immune for the duration of the Dash
  - 'Damage: 200 | 275 | 350 | 425 | 500'
  - 'Damage Scaling: 100% Strength'
  - 'Stun Duration: 1.25 seconds'
  - 'Minimum Speed Buff: 15%'
  - 'Maximum Speed Buff: 30%'
  - 'Buff Duration: 5 seconds'
  - 'Min Range: 0 meters'
  - 'Max Range: 48 meters'
  - 'Radius: 2.59 meters'
