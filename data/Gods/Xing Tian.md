...
- slot: Passive
  ...
  details:
  - Stack duration refreshes when you hit with an ability
  - 'Health Regen: 0.6'
  - 'Maximum Health: 5'
  - 'Buff Duration: 18 seconds'
  - 'Max Stacks: 12'
...
- slot: 1st Ability
  ...
  - 'Damage Per Tick: 1 | 1.5 | 2 | 2.5 | 3% of Enemy''s Max Health'
...
- slot: 2nd Ability
  ...
  - 70.0
  details:
  - 'Axe Damage: 35 | 50 | 65 | 80 | 95'
  - 'Axe Damage Scaling: 25% Intelligence'
  - 'Slam Damage: 50 | 80 | 110 | 140 | 170'
  - 'Slam Damage Scaling: 45% Intelligence'
...
- slot: 3rd Ability
  ...
  - 60.0
  details:
  - Hitting an enemy god grants Protections for a duration
  - Refreshes Furious Roar damage over time on enemies hit
...
- slot: Ultimate
  ...
  - 75.0
  details:
  - Grabbed enemies take Magical Damage on the Grab, repeatedly during the spin, and
    again on the Throw
  - You are CC Immune during and briefly after this ability, and you gain a Movement
    Speed buff while channeling
...
- name: Aspect of Relentless Spite
  kit_changes: Smouldering Rage no longer grants Health Regen or temporary Maximum
    Health. Instead, you gain Spite, a resource that stacks up to 100 and starts at
    max. Sky-Cutting Axe no longer grants protections. Whirlwind of Rage and Steel
