...
- slot: Passive
  name: Unbound Runes
  details:
  - At 5 Runes your next cast of Unchained or Brutalize becomes Empowered and gains
    an additional effect
  description: Your Runes are activated by successful Basic Attacks, or by activating
    abilities. You activate 5 Runes on killing an enemy god.
- slot: 1st Ability
  name: Unchained
  cooldown:
  - 15.0
  ...
  - 'Damage Scaling: 85% Strength + 30% Physical and Magical Protection'
...
- slot: 3rd Ability
  ...
  - When Empowered, deal increased Physical Damage repeatedly instead, then all Runes
    are consumed
  ...
  - 'Increased Damage Scaling: 55% Strength'
...
- slot: Ultimate
  ...
  - 100.0
  details:
  - Gain increased Movement Speed, Protections, and become CC Immune while massive
  - If Empowered, remove all Runes for no benefit
  - If not Empowered, gain 5 Runes
  - You can cancel this ability at any time
  - 'Damage: 200 | 275 | 350 | 425 | 500'
  - 'Damage Scaling: 115% Strength'
  - 'Movement Speed: 75%'
  - 'Protections: 20 | 25 | 30 | 35 | 40 + 15%'
