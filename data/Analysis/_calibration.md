...
|---|---|---|---|
| win only (Spearman's target verbatim) | 1.000 | +1.00 (positive on 87/87) | 43.1% |
| pick only (community membership) | 0.136 | -0.02 (positive on 35/87) | 92.9% |
| model only (efficiency + fit) | 0.018 | +0.05 (positive on 44/87) | 35.5% |
...
|---|---|---|---|---|
| 0.00 | 1.00 | 27.0% | [22.0%, 33.0%] | 4.5x |
| 0.05 | 0.95 | 28.2% | [22.9%, 33.8%] | 4.7x |
| 0.10 | 0.90 | 28.7% | [23.3%, 34.3%] | 4.8x |
| 0.15 | 0.85 | 28.5% | [23.5%, 34.1%] | 4.8x |
| 0.20 | 0.80 | 29.5% | [24.6%, 34.9%] | 4.9x |
| 0.25 | 0.75 | 30.0% | [25.2%, 35.4%] | 5.0x |
| 0.30 | 0.70 | 30.3% | [25.5%, 35.4%] | 5.1x |
| 0.35 | 0.65 | 31.1% | [26.4%, 36.2%] | 5.2x |
| 0.40 | 0.60 | 31.3% | [26.7%, 36.4%] | 5.2x |
| 0.45 | 0.55 | 31.4% | [26.5%, 36.6%] | 5.3x |
| 0.50 | 0.50 | 32.3% | [27.3%, 37.5%] | 5.4x |
| 0.55 | 0.45 | 33.0% | [28.1%, 38.2%] | 5.5x |
| 0.60 | 0.40 | 32.6% | [27.6%, 38.0%] | 5.5x |
| 0.65 | 0.35 | 35.7% | [30.6%, 40.7%] | 6.0x |
| 0.70 | 0.30 | 35.5% | [30.1%, 40.9%] | 5.9x |
| 0.75 | 0.25 | 32.4% | [27.5%, 37.5%] | 5.4x |
| 0.80 | 0.20 | 30.2% | [25.6%, 35.0%] | 5.1x |
| 0.85 | 0.15 | 25.2% | [21.1%, 29.5%] | 4.2x |
| 0.90 | 0.10 | 21.8% | [17.9%, 25.6%] | 3.6x |
| 0.95 | 0.05 | 16.6% | [13.0%, 20.4%] | 2.8x |
| 1.00 | 0.00 | 15.7% | [12.1%, 19.2%] | 2.6x |

Best: efficiency 0.65 : fit 0.35 at 35.7%. **17 of 21 splits have a CI overlapping it** — treat a winner inside that band as noise and leave the shipped split alone.
...
|---|---|---|---|---|---|---|
| 0.35 | 0.35 | 0.15 | 0.15 | 0.691 | 0.58 | 59% |
| 0.3 | 0.35 | 0.15 | 0.2 | 0.691 | 0.54 | 61% |
| 0.4 | 0.35 | 0.15 | 0.1 | 0.681 | 0.60 | 56% |
| 0.35 | 0.4 | 0.1 | 0.15 | 0.673 | 0.63 | 53% |
| 0.35 | 0.3 | 0.15 | 0.2 | 0.671 | 0.48 | 60% |
| 0.25 | 0.35 | 0.15 | 0.25 | 0.666 | 0.50 | 58% |
| 0.4 | 0.3 | 0.15 | 0.15 | 0.664 | 0.51 | 57% |
| 0.3 | 0.4 | 0.1 | 0.2 | 0.661 | 0.59 | 53% |
| 0.45 | 0.35 | 0.15 | 0.05 | 0.661 | 0.61 | 52% |
| 0.4 | 0.4 | 0.1 | 0.1 | 0.658 | 0.65 | 49% |
| 0.3 | 0.3 | 0.15 | 0.25 | 0.656 | 0.45 | 59% |
| 0.45 | 0.3 | 0.15 | 0.1 | 0.655 | 0.53 | 55% |
| 0.35 | 0.35 | 0.1 | 0.2 | 0.649 | 0.53 | 53% |
| 0.2 | 0.35 | 0.15 | 0.3 | 0.648 | 0.47 | 56% |
| 0.4 | 0.25 | 0.15 | 0.2 | 0.648 | 0.41 | 59% |
