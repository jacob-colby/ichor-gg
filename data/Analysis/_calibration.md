...
_Input fingerprint: `047109f54fd7` — items, gods, tags, community builds, weights. Check it against `python -m smite.calibrate --control` before quoting any number below._
