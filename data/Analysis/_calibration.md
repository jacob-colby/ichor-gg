...
_Input fingerprint: `9f722a7ad5c8` — items, gods, tags, community builds, weights. Check it against `python -m smite.calibrate --control` before quoting any number below._
...
- without Ravana: eff 0.35 · win 0.35 · pick 0.15 · fit 0.15
...
**Stability:** 1 distinct fold-winner(s) across 90 folds — stable.
