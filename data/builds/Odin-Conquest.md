...
- source: community
  ...
  god_win_rate: 0.5894736842105263
  god_matches_won: 224
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Midgardian Mail, Daybreak Gavel, Titan''s Bane, The Crusher, Magi''s Cloak.'
  slot_scores:
    Genji's Guard:
      total: 0.59
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    for this god: Amanita Charm, Kinetic Cuirass, Stone of Binding, Avenging Blade,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Heartseeker, Pendulum Blade, Glorious Pridwen.'
  slot_scores:
    Genji's Guard:
      total: 0.62
      efficiency: 0.66
