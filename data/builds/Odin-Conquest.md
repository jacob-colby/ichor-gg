...
- source: community
  ...
  god_win_rate: 0.5566037735849056
  god_matches_won: 177
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Amanita
    Charm, Kinetic Cuirass, Draconic Scale, Shield Splitter, Hydra''s Lament, Runeforged
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    of Binding, Midgardian Mail, Daybreak Gavel, Titan''s Bane, The Crusher, Hide
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Berserker''s Shield, Amanita Charm, Kinetic Cuirass, Draconic Scale,
    Golden Blade, Riptalon, Tyrfing, Silverbranch Bow, Shield Splitter, Runeforged
    Hammer, Pharaoh''s Curse, Lernaean Bow, Toxic Blade, Shogun''s Ofuda, Erosion,
    The Reaper, Stone of Binding, Eye of Providence, Hydra''s Lament, Eye of the Storm,
    Shield of the Phoenix, Tekko-Kagi, Magi''s Cloak, Heartseeker, Daybreak Gavel.'
  slot_scores:
    Golden Blade:
      total: 0.51
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Pendulum Blade, Glorious Pridwen, Hide of the Nemean Lion.'
  slot_scores:
    Breastplate of Valor:
      total: 0.53
      efficiency: 0.65
