...
- source: community
  ...
  god_win_rate: 0.5639097744360902
  god_matches_won: 75
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Asclepius, Gem of Focus, Bancroft''s Talon, Jade Scepter, Freya''s Tears, Bracer
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Helm of Radiance, Blood-Bound Book, Rod of Asclepius, Kinetic Cuirass, Gem of
    Focus, Amanita Charm, Screeching Gargoyle, Triton''s Conch.'
  slot_scores:
    Chronos' Pendant:
      total: 0.58
      efficiency: 0.55
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Grace, Spear of the Magus, Gem of Focus, Death Metal, Gladiator''s Shield, Kinetic
