...
- source: community
  ...
  god_win_rate: 0.46648793565683644
  god_matches_won: 174
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Staff, Freya''s Tears, Alchemist Coat, Shield of the Phoenix.'
  slot_scores:
    Gluttonous Grimoire:
      total: 0.56
      efficiency: 0.63
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Helm of Radiance, Jade Scepter, Leviathan''s Hide, Midgardian Mail.'
  slot_scores:
    Genji's Guard:
      total: 0.48
      efficiency: 0.69
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Stone of Binding, Kinetic Cuirass, Bracer of The Abyss, Ethereal Staff, Void Shield.'
  slot_scores:
    Gluttonous Grimoire:
      total: 0.56
      efficiency: 0.63
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Oni Hunter''s Garb, Shield of the Phoenix, Doom Orb, Jade Scepter, Spectral Armor.'
  slot_scores:
    Bracer of The Abyss:
      total: 0.44
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Radiance, Oni Hunter''s Garb, Blood-Bound Book, Rod of Asclepius.'
  slot_scores:
    Genji's Guard:
      total: 0.51
      efficiency: 0.69
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Ethereal Staff, Freya''s Tears, Alchemist Coat, Shield of the Phoenix.'
  slot_scores:
    Gluttonous Grimoire:
      total: 0.56
      efficiency: 0.63
