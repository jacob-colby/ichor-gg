...
- source: community
  ...
  god_win_rate: 0.5630498533724341
  god_matches_won: 384
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Draconic Scale, Soul Gem, Erosion, Eye of Providence, Ethereal
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Grimoire, Draconic Scale, Soul Gem, Helm of Radiance, Erosion, Stone of Binding,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gem, Draconic Scale, Chronos'' Pendant, Helm of Radiance, Prophetic Cloak, Gluttonous
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Blade, Draconic Scale, Gluttonous Grimoire, Eye of the Storm, Hydra''s Lament,
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Radiance, Soul Gem, Draconic Scale, Obsidian Shard, Golden Blade, Nimble Ring,
