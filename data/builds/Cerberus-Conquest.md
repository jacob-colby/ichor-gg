...
- source: community
  ...
  god_win_rate: 0.5403022670025189
  god_matches_won: 429
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Nemean Lion, Leviathan''s Hide, Prophetic Cloak, Void Shield, Stampede, Ancile,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Grimoire, Phoenix Feather, Yogi''s Necklace, Chandra''s Grace, Lifebinder, Glorious
    Pridwen, Stone of Binding, Midgardian Mail, Helm of Radiance, Hide of the Nemean
    Lion, Sphere of Negation, Leviathan''s Hide, Magi''s Cloak, Void Shield, Stampede.'
  slot_scores:
    Breastplate of Valor:
      total: 0.54
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Dreamer''s Idol, Nimble Ring, Mantle Of Discord, Midgardian Mail, Rod of Asclepius.'
  slot_scores:
    Stone of Binding:
      total: 0.54
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Stampede, Ancile, Spear of Desolation, Nimble Ring, Helm of Darkness, Oni Hunter''s
