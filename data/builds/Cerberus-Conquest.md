...
- source: community
  ...
  god_win_rate: 0.5260869565217391
  god_matches_won: 121
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Lion, Sphere of Negation, Leviathan''s Hide, Magi''s Cloak, Void Shield, Draconic
    Scale.'
  slot_scores:
    Genji's Guard:
      total: 0.52
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Lion, Leviathan''s Hide, Draconic Scale.'
  slot_scores:
    Breastplate of Valor:
      total: 0.57
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Ofuda, Screeching Gargoyle, Mantle Of Discord, Midgardian Mail, Draconic Scale.'
  slot_scores:
    Genji's Guard:
      total: 0.51
      efficiency: 0.66
