...
- source: community
  ...
  god_win_rate: 0.568738229755179
  god_matches_won: 302
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Magi''s Cloak, Helm of Radiance, Gluttonous Grimoire, Mantle Of
    Discord, Midgardian Mail, Screeching Gargoyle, Prophetic Cloak, Hide of the Nemean
    Lion, Helm of Darkness, Leviathan''s Hide, Void Shield, Ancile, Oni Hunter''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Chandra''s Grace, Glorious Pridwen, Draconic Scale, Lifebinder, Midgardian Mail,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Soul Gem, Void Shield, Shifter''s Shield, Breastplate of Valor, Obsidian Shard,
    ...
    Midgardian Mail, Draconic Scale, Rod of Asclepius, Hide of the Nemean Lion.'
  slot_scores:
    Screeching Gargoyle:
      total: 0.54
      efficiency: 0.51
