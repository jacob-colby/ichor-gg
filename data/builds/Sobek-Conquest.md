...
- source: community
  ...
  god_win_rate: 0.5341802782819117
  god_matches_won: 883
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Hide, Void Shield, Hide of the Nemean Lion, Ancile, Oni Hunter''s Garb, Xibalban
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Breastplate of Valor, Soul Gem, Erosion, Shifter''s Shield,
    Eye of Providence, Ethereal Staff, Gluttonous Grimoire, Phoenix Feather, Yogi''s
    Necklace, Chandra''s Grace, Glorious Pridwen, Lifebinder, Midgardian Mail, Stone
    of Binding, Helm of Radiance, Leviathan''s Hide, Void Shield, Hide of the Nemean
    Lion, Magi''s Cloak, Ancile.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.56
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    of Valor, Gluttonous Grimoire, Soul Gem, Helm of Radiance, Erosion, Shifter''s
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shifter''s Shield, Gluttonous Grimoire, Eye of Providence, Gladiator''s Shield,
