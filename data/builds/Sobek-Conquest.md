...
- source: community
  ...
  god_win_rate: 0.5568627450980392
  god_matches_won: 284
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Cloak, Breastplate of Valor, Erosion, Eye of Providence, Shield of the Phoenix,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Soul Gem, Shifter''s Shield, Void Shield, Breastplate of Valor, Obsidian Shard,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Amanita Charm, Prophetic Cloak, Kinetic Cuirass, Shield of the Phoenix, Spear
    of Desolation, Screeching Gargoyle, Shifter''s Shield, Soul Gem, Chronos'' Pendant,
