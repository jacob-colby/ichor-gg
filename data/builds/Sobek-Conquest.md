...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Effigy, Spear of Desolation, Hussar''s Wings, Prophetic Cloak.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.55
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Rod of Asclepius, Shifter''s Shield, Soul Gem, Erosion, Eye of
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Kinetic Cuirass, Screeching Gargoyle, Spear of Desolation, Draconic Scale, Spear
    of the Magus, Soul Gem, Void Shield, Breastplate of Valor, Obsidian Shard, Shifter''s
    Shield, Void Stone, Erosion, Eye of Providence, Shield of the Phoenix, Doom Orb,
    Helm of Radiance, The World Stone, Dreamer''s Idol, Magi''s Cloak, Mantle Of Discord,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Grimoire, Breastplate of Valor, Draconic Scale, Shifter''s Shield, Soul Gem, Helm
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Amanita Charm, Kinetic Cuirass, Shield of the Phoenix, Spear of Desolation, Draconic
    Scale, Screeching Gargoyle, Soul Gem, Shifter''s Shield, Chronos'' Pendant, Erosion,
    Helm of Radiance, Gluttonous Grimoire, Eye of Providence, Gladiator''s Shield,
    Stone of Binding, Gem of Focus, Magi''s Cloak, Prophetic Cloak, Rod of Asclepius,
