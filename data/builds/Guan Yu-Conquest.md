...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    of Binding, Shifter''s Shield, Pharaoh''s Curse, Avenging Blade, Lernaean Bow,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Curse, Shifter''s Shield, Riptalon, Lernaean Bow, Shogun''s Ofuda, Stone of Binding,
    Screeching Gargoyle.'
  slot_scores:
    Berserker's Shield:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shifter''s Shield, Daybreak Gavel, Midgardian Mail, Shogun''s Ofuda, Mantle Of
    Discord.'
  slot_scores:
    Berserker's Shield:
      total: 0.54
