...
- source: community
  ...
  god_win_rate: 0.5201072386058981
  god_matches_won: 582
  god_matches_played: 1119
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Shifter''s Shield, Magi''s Cloak, Shogun''s Ofuda, Midgardian Mail, Mantle Of
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Curse, Riptalon, Lernaean Bow, Shogun''s Ofuda, Stone of Binding, Shifter''s Shield,
    Screeching Gargoyle.'
  slot_scores:
    Berserker's Shield:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Daybreak Gavel, Midgardian Mail, Shogun''s Ofuda, Shifter''s Shield, Mantle Of
    Discord.'
  slot_scores:
    Berserker's Shield:
      total: 0.54
