...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Berserker''s Shield, Shield of the Phoenix, Kinetic Cuirass, Amanita Charm, Hydra''s
    Lament, Oni Hunter''s Garb, The Crusher, Screeching Gargoyle, Pharaoh''s Curse,
    Chandra''s Grace, Gladiator''s Shield, Spectral Armor, Erosion, Runeforged Hammer,
    Eye of Providence, Prophetic Cloak, Shield Splitter, Shogun''s Ofuda, Draconic
    Scale, Golden Blade, Leviathan''s Hide, Eye of the Storm, Lernaean Bow, Midgardian
    Mail.'
  slot_scores:
    Genji's Guard:
      total: 0.61
