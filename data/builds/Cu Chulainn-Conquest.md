...
- source: community
  ...
  god_win_rate: 0.49530621367903443
  god_matches_won: 1108
  god_matches_played: 2237
...
- source: suggested
  ...
  - added: Hide of the Nemean Lion
    ...
    reason: community 58% win over 179 matches (vs 50% on this god), taking the model's
      weakest slot from Kinetic Cuirass
  - added: Draconic Scale
    removed: Runeforged Hammer
    reason: community 57% win over 179 matches (vs 50% on this god), taking the model's
