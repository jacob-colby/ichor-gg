...
- source: community
  ...
  god_win_rate: 0.5045045045045045
  god_matches_won: 224
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    this god: Rod of Tahuti, Amanita Charm, Draconic Scale, Berserker''s Shield, Jotunn''s
    ...
    Hide, Sphere of Negation, Void Shield, Stampede, Heartseeker, Ancile, Hide of
    the Nemean Lion.'
  slot_scores:
    Berserker's Shield:
      total: 0.58
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Idol, Pendulum Blade, Obsidian Shard, Nimble Ring, Daybreak Gavel, Helm of Radiance,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Draconic Scale, Breastplate of Valor, Berserker''s Shield, Amanita Charm, Spear
