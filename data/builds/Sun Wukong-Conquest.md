...
- source: community
  ...
  god_win_rate: 0.5046382189239332
  god_matches_won: 272
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    The Reaper, Breastplate of Valor, Eye of Providence, Yogi''s Necklace, Phoenix
    ...
    Helm of Radiance, Chandra''s Grace, Daybreak Gavel, Hide of the Nemean Lion, Magi''s
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Hammer, Stone of Binding, Spear of Desolation, Tekko-Kagi, Titan''s Bane, Kinetic
    ...
    Idol, Obsidian Shard, Pendulum Blade, Nimble Ring, Daybreak Gavel, Helm of Radiance,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Breastplate of Valor, Draconic Scale, Berserker''s Shield, Amanita Charm, Spear
    of Desolation, Hydra''s Lament, Shield of the Phoenix, Soul Gem, Chronos'' Pendant,
    Kinetic Cuirass, Screeching Gargoyle, Runeforged Hammer, Gluttonous Grimoire,
    ...
    Death, Pendulum Blade, Shogun''s Ofuda, Obsidian Shard.'
  slot_scores:
    Berserker's Shield:
      total: 0.54
      efficiency: 0.68
