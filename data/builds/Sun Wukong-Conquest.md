...
- source: community
  ...
  god_win_rate: 0.4678362573099415
  god_matches_won: 80
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    of Binding, Dominance, Spear of the Magus, Titan''s Bane, Death Metal, Leviathan''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Shield, Stampede, Heartseeker, Ancile.'
  slot_scores:
    Genji's Guard:
      total: 0.55
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Blade, Amanita Charm, Heartseeker, Spear of the Magus, Stone of Binding, Spear
    ...
    of Asclepius, Eye of Providence, Shield of the Phoenix, Obsidian Shard.'
  slot_scores:
    Book of Thoth:
      total: 0.4
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Heartseeker, Draconic Scale, Obsidian Shard.'
  slot_scores:
    Golden Blade:
      total: 0.51
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Valor, Gladiator''s Shield, Berserker''s Shield, Amanita Charm, Spear of Desolation,
    Hydra''s Lament, Shield of the Phoenix, Soul Gem, Kinetic Cuirass, Screeching
    Gargoyle, Gluttonous Grimoire, Runeforged Hammer, Arondight, Gem of Focus, Nimble
    Ring, Eye of Erebus, Helm of Radiance, Rod of Asclepius, Shield Splitter, Spear
    of the Magus, Prophetic Cloak, Chandra''s Grace, Eye of the Storm, Chronos'' Pendant,
