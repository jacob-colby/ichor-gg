...
- source: community
  ...
  god_win_rate: 0.4979919678714859
  god_matches_won: 124
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Lament, Shield Splitter, Hide of the Nemean Lion, Shield of the Phoenix, Avenging
    ...
    Wyrmskin Hide, Bragi''s Harp, Ancile, Genji''s Guard, Breastplate of Valor.'
  slot_scores:
    Berserker's Shield:
      total: 0.54
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Talon, Death Metal, Ancile, Damaru, Genji''s Guard, Breastplate of Valor.'
  slot_scores:
    Berserker's Shield:
      total: 0.55
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Metal, Erosion, Pendulum Blade, Genji''s Guard, Breastplate of Valor.'
  slot_scores:
    Berserker's Shield:
      total: 0.52
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Damaru, Genji''s Guard, Breastplate of Valor.'
  slot_scores:
    Golden Blade:
      total: 0.53
      efficiency: 0.53
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Chronos'' Pendant, Chandra''s Grace, Genji''s Guard, Spear of Desolation, Breastplate
    of Valor, Screeching Gargoyle, Oni Hunter''s Garb, Gladiator''s Shield, Pharaoh''s
    Curse, Gem of Focus, Spectral Armor, Golden Blade, Totem of Death, Arondight,
    Erosion, Rod of Asclepius, Death Metal, Prophetic Cloak, Eye of the Storm, The
    Cosmic Horror, Eye of Providence, Leviathan''s Hide, Shogun''s Ofuda, Helm of
    Radiance, Midgardian Mail, Spear of the Magus, Jade Scepter.'
  slot_scores:
    Berserker's Shield:
      total: 0.52
      efficiency: 0.66
