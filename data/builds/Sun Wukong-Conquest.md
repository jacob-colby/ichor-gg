...
- source: community
  ...
  god_win_rate: 0.4596774193548387
  god_matches_won: 57
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Gluttonous Grimoire, Lernaean Bow, Breastplate of Valor, Hydra''s Lament, Hide
    of the Nemean Lion, Erosion, Pharaoh''s Curse, Eye of Providence, Heartseeker,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    of Valor, Eye of Providence, Yogi''s Necklace, Hide of the Nemean Lion, Draconic
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Breastplate of Valor, Runeforged Hammer, Gladiator''s Shield, Berserker''s Shield,
