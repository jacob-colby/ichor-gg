...
- source: community
  ...
  god_win_rate: 0.5572519083969466
  god_matches_won: 146
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Bow, Riptalon, Tyrfing, Transcendence, Oath-Sworn Spear, Toxic Blade, Arondight,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    of Valor, Genji''s Guard, Avatar''s Parashu, Transcendence, Eye of Erebus, Tyrfing,
