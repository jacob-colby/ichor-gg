...
- source: community
  ...
  god_win_rate: 0.4943181818181818
  god_matches_won: 87
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Avenging Blade, Phoenix Feather, Daybreak Gavel, Chandra''s Grace, Stone of Binding,
    Midgardian Mail, Magi''s Cloak, Leviathan''s Hide, Heartseeker, Void Shield.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.63
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Lernaean Bow, Shogun''s Ofuda, Daybreak Gavel, Silverbranch Bow, Erosion, Eye
    of Providence, Stone of Binding, Toxic Blade, Eye of the Storm, Shield of the
    Phoenix, Hydra''s Lament, Draconic Scale, Magi''s Cloak, Screeching Gargoyle,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Eye of Providence, Gladiator''s Shield, Daybreak Gavel, Draconic Scale, Stone
    of Binding, Eye of the Storm, Arondight, Magi''s Cloak, Eye of Erebus, Mantle
    Of Discord, Midgardian Mail, Chandra''s Grace, Leviathan''s Hide.'
  slot_scores:
    Breastplate of Valor:
      total: 0.57
      efficiency: 0.65
