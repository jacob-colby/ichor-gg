...
- source: community
  ...
  god_win_rate: 0.46757679180887374
  god_matches_won: 137
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Avenging Blade, Phoenix Feather, Chandra''s Grace, Glorious Pridwen, Daybreak
    Gavel, Stone of Binding, Midgardian Mail, Magi''s Cloak, Leviathan''s Hide, Heartseeker,
    Void Shield.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.6
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Daybreak Gavel, Magi''s Cloak, Screeching Gargoyle, The Reaper,
    Tekko-Kagi.'
  slot_scores:
    Golden Blade:
      total: 0.49
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    of the Storm, Arondight, Magi''s Cloak, Daybreak Gavel, Eye of Erebus, Mantle
