...
- source: community
  ...
  god_win_rate: 0.5015576323987538
  god_matches_won: 161
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Hammer, Oni Hunter''s Garb, Eye of the Storm, The Reaper, Shield Splitter, Erosion,
    Hydra''s Lament, Phoenix Feather, Eye of Providence, Spectral Armor, Draconic
    Scale, Golden Blade, Avenging Blade, Pharaoh''s Curse, Leviathan''s Hide, Midgardian
    Mail, Riptalon.'
  slot_scores:
    Genji's Guard:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Shield, Oni Hunter''s Garb, The Reaper, Void Stone, Shield of the Phoenix, Runeforged
    Hammer, Shield Splitter, Hydra''s Lament, Erosion, Spectral Armor, Eye of the
    Storm, Eye of Providence, Draconic Scale, Pharaoh''s Curse, Riptalon, Heartseeker,
    Leviathan''s Hide.'
  slot_scores:
    Genji's Guard:
      total: 0.54
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Hammer, Stampede, Void Stone, Eye of the Storm, Eye of Providence, Shield Splitter,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Revenge, Pharaoh''s Curse, Berserker''s Shield, Shogun''s Ofuda, Hydra''s Lament,
    Void Shield, Doublet of Binding, Oni Hunter''s Garb, Stampede, Void Stone, The
    Crusher, Gladiator''s Shield, Screeching Gargoyle, Umbral Link, Runeforged Hammer,
    Mystical Mail, Eye of Providence, Draconic Scale.'
  slot_scores:
    Genji's Guard:
      total: 0.57
      efficiency: 0.69
