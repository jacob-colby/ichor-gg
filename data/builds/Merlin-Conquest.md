...
- source: community
  ...
  god_win_rate: 0.5977011494252874
  god_matches_won: 52
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Blood-Bound Book, Jade Scepter, Bancroft''s Talon, Helm of Radiance, Ethereal
    Staff, Staff of Myrddin, Wish-Granting Pearl, Typhon’s Heart, Bracer of The Abyss,
    Nimble Ring, Book of Thoth.'
  slot_scores:
    Nimble Ring:
      total: 0.5
      efficiency: 0.39
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Spear
    ...
    Bancroft''s Talon, Triton''s Conch, Blood-Bound Book, Jade Scepter, Wish-Granting
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Asclepius, Polynomicon, Blood-Bound Book, Jade Scepter, Triton''s Conch, Breastplate
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Valor, Bracer of The Abyss, Book of Thoth.'
  slot_scores:
    Nimble Ring:
      total: 0.48
      efficiency: 0.39
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Typhon’s Heart, Polynomicon, Jade Scepter, Helm of Radiance, Daybreak Gavel, Book
    of Thoth.'
  slot_scores:
    Bracer of The Abyss:
      total: 0.54
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Freya''s Tears, Polynomicon, Blood-Bound Book, Jade Scepter, Book of Thoth.'
  slot_scores:
    Chronos' Pendant:
      total: 0.6
      efficiency: 0.55
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    of Thoth, Polynomicon, Blood-Bound Book, Jade Scepter, Bancroft''s Talon, Helm
