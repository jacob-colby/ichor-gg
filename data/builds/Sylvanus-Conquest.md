...
- source: community
  ...
  god_win_rate: 0.5260545905707196
  god_matches_won: 212
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Rod of Tahuti, Amanita Charm, Kinetic Cuirass, Shifter''s Shield, Stampede,
    Erosion, Eye of Providence, Shield of the Phoenix, Draconic Scale, Helm of Radiance,
    Gluttonous Grimoire, Stone of Binding, Spear of Desolation, Magi''s Cloak, Screeching
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Necklace, Glorious Pridwen, Helm of Radiance, Spear of Desolation, Sphere of Negation,
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Hammer, Gluttonous Grimoire, Tyrfing, Hydra''s Lament, Shifter''s Shield, Spear
