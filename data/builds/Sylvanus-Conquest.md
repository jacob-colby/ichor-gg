...
- source: community
  ...
  god_win_rate: 0.5074183976261127
  god_matches_won: 342
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Erosion, Eye of Providence, Chandra''s Grace, Draconic Scale, Lifebinder, Phoenix
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Pharaoh''s Curse, Rod of Asclepius, Magi''s Cloak, Bragi''s Harp, Tyrfing, The
...
- source: suggested
  ...
  - added: Spirit Robe
    ...
    reason: community 77% win over 34 matches (vs 51% on this god), taking the model's
