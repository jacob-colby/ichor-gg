...
- source: community
  ...
  god_win_rate: 0.5094527363184079
  god_matches_won: 512
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Rod of Tahuti, Amanita Charm, Kinetic Cuirass, Breastplate of Valor,
    Shifter''s Shield, Erosion, Eye of Providence, Shield of the Phoenix, Draconic
    Scale, Helm of Radiance, Gluttonous Grimoire, Stone of Binding, Spear of Desolation,
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Golden Blade, Runeforged Hammer, Tyrfing, Gluttonous Grimoire, Hydra''s Lament,
...
- source: suggested
  ...
  - added: Spirit Robe
    ...
    reason: community 74% win over 40 matches (vs 51% on this god), taking the model's
