...
- source: community
  ...
  god_win_rate: 0.5398963730569948
  god_matches_won: 521
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Stampede, Midgardian Mail, Hide of the Nemean Lion, Spear of the Magus, Leviathan''s
...
- source: suggested
  ...
  - added: Shell of Rebuke
    ...
    reason: community 69% win over 48 matches (vs 54% on this god), taking the model's
