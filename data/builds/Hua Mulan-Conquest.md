...
- source: community
  ...
  god_win_rate: 0.549645390070922
  god_matches_won: 155
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Runeforged Hammer, Riptalon, Lernaean Bow, Shogun''s Ofuda, Silverbranch Bow,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Hydra''s Lament, Screeching Gargoyle, Shield Splitter, Prophetic Cloak, Runeforged
    Hammer, Erosion, Eye of Providence, Stone of Binding, Golden Blade, Eye of the
