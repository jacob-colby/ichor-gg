...
- source: community
  ...
  god_win_rate: 0.49528301886792453
  god_matches_won: 105
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Shifter''s Shield, Soul Gem, Erosion, Eye of Providence, Draconic Scale, Yogi''s
    Necklace, Ethereal Staff, Gluttonous Grimoire, Phoenix Feather, Chandra''s Grace,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Nimble Ring, Kinetic Cuirass, Gluttonous Grimoire, Shifter''s
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Charm, Kinetic Cuirass, Shield Splitter, Golden Blade, Runeforged Hammer, Shifter''s
    Shield, Gluttonous Grimoire, Eye of the Storm, Tyrfing, Hydra''s Lament, Heartseeker,
    ...
    Helm of Radiance, Stone of Binding, Draconic Scale, Toxic Blade, Obsidian Shard,
    Titan''s Bane, The Crusher, Pharaoh''s Curse, Nimble Ring, Magi''s Cloak, The
    Reaper, Screeching Gargoyle, Shogun''s Ofuda, Mantle Of Discord, Midgardian Mail.'
  slot_scores:
    Book of Thoth:
      total: 0.42
      efficiency: 0.51
