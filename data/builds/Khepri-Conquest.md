...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Scale, Ethereal Staff, Breastplate of Valor, Gluttonous Grimoire, Phoenix Feather,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    the Magus, Void Shield, Obsidian Shard, Void Stone, Shifter''s Shield, Breastplate
    of Valor, Erosion, Eye of Providence, Shield of the Phoenix, Draconic Scale, Doom
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Hammer, Breastplate of Valor, Shifter''s Shield, Gluttonous Grimoire, Eye of the
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Splitter, Spear of the Magus, Soul Gem, Runeforged Hammer, Helm of Radiance, Breastplate
    of Valor, Shifter''s Shield, Obsidian Shard, Berserker''s Shield, Eye of the Storm,
