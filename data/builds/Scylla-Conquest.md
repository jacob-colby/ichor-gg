...
- source: community
  ...
  god_win_rate: 0.5433168316831684
  god_matches_won: 439
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Guard, Helm of Radiance, Breastplate of Valor, Ethereal Staff.'
  slot_scores:
    Book of Thoth:
      total: 0.48
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Shield, Genji''s Guard, Lifebinder, Helm of Radiance, Breastplate of Valor, Sphere
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Dreamer''s Idol, Genji''s Guard, Breastplate of Valor, Ancient Signet, Death Metal,
