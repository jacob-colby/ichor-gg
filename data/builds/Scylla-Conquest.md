...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Guard, Helm of Radiance, Ethereal Staff, Breastplate of Valor.'
  slot_scores:
    Book of Thoth:
      total: 0.46
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Yogi''s Necklace, Breastplate of Valor, Eye of Providence, Draconic Scale, Phoenix
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Idol, Genji''s Guard, Ancient Signet, Death Metal, Breastplate of Valor, Staff
    of Myrddin, The Cosmic Horror, Eye of Erebus, Screeching Gargoyle, Bragi''s Harp,
    Rod of Asclepius, Doom Orb, Chandra''s Grace, Freya''s Tears, Blood-Bound Book,
