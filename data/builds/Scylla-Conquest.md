...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Pendant, The World Stone, Dreamer''s Idol, Genji''s Guard, Gem of Focus, Totem
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Scepter, Ancient Signet, Ethereal Staff, Stone of Binding.'
  slot_scores:
    Spear of Desolation:
      total: 0.55
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Garb, Freya''s Tears, The World Stone, Dreamer''s Idol, Eye of Providence, Gem
    of Focus.'
  slot_scores:
    Yogi's Necklace:
      total: 0.49
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gargoyle, Chandra''s Grace, Death Metal, Gladiator''s Shield, The World Stone,
