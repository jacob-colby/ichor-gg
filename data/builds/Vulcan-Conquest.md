...
- source: community
  ...
  god_win_rate: 0.5394736842105263
  god_matches_won: 164
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Gluttonous Grimoire, Chronos'' Pendant, Nimble Ring, The Cosmic Horror,
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Gluttonous
    Grimoire, Chronos'' Pendant, Nimble Ring, Genji''s Guard, Death Metal, The Cosmic
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Pendant, Nimble Ring, Doom Orb, Dreamer''s Idol, Genji''s Guard, Screeching Gargoyle,
    Breastplate of Valor, Bracer of The Abyss, Death Metal, Helm of Radiance, Blood-Bound
    Book, Rod of Asclepius, Gem of Focus, Stone of Binding, Bancroft''s Talon, Freya''s
    Tears, Totem of Death, Jade Scepter, Kinetic Cuirass.'
  slot_scores:
    Spear of Desolation:
      total: 0.56
      efficiency: 0.52
