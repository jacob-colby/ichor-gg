...
- source: community
  ...
  god_win_rate: 0.5868055555555556
  god_matches_won: 338
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Rod
    ...
    Silverbranch Bow, The World Stone, Chronos'' Pendant, Dominance, Deathbringer,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    of Negation, Hydra''s Lament, Pharaoh''s Curse, Shogun''s Ofuda, Chandra''s Grace,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Oath-Sworn Spear, Demon Blade, Gem of Focus, The Executioner.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.6
      efficiency: 0.72
