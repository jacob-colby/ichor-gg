...
- source: community
  ...
  god_win_rate: 0.5819935691318328
  god_matches_won: 181
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Harp, Bracer of The Abyss, Kinetic Cuirass, Toxic Blade, Doom Orb, Chronos'' Pendant,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Harp, Toxic Blade, Runeforged Hammer, Kinetic Cuirass, Pharaoh''s Curse, Chronos''
    ...
    Asclepius, Shield of the Phoenix, Shogun''s Ofuda.'
  slot_scores:
    Berserker's Shield:
      total: 0.54
      efficiency: 0.66
...
- source: suggested
  ...
  - added: Silverbranch Bow
    removed: Death Metal
    reason: community 75% win over 40 matches (vs 58% on this god), taking the model's
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Breastplate of Valor, Pharaoh''s Curse, Toxic Blade, Spear of Desolation, Oni
