...
- source: community
  ...
  god_win_rate: 0.5703971119133574
  god_matches_won: 158
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Polynomicon, Genji''s Guard, Blood-Bound Book, Soul Reaver, Jade Scepter, Divine
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    the Phoenix, Gluttonous Grimoire, Kinetic Cuirass, Genji''s Guard, Ethereal Staff,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Focus, Spear of the Magus, Gluttonous Grimoire, Totem of Death, Genji''s Guard,
    Doom Orb, The World Stone, Freya''s Tears, Breastplate of Valor, Dreamer''s Idol,
    Ancient Signet, Death Metal, Book of Thoth, Staff of Myrddin, The Cosmic Horror,
    Eye of Erebus, Screeching Gargoyle, Bragi''s Harp, Rod of Asclepius, Polynomicon,
    Blood-Bound Book, Soul Reaver, Chandra''s Grace, Jade Scepter.'
  slot_scores:
    Chronos' Pendant:
      total: 0.54
      efficiency: 0.55
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Book of Thoth, Gem of Focus, Avatar''s Parashu, Tyrfing, The Cosmic Horror, Transcendence,
