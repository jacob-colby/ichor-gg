...
- source: community
  ...
  god_win_rate: 0.5873684210526315
  god_matches_won: 279
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Revenge, Erosion, Eye of Providence, Breastplate of Valor, Draconic Scale, Berserker''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Shield, Erosion, Eye of Providence, Draconic Scale, Breastplate of Valor, Ethereal
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Shard, Breastplate of Valor, Avenging Blade, Berserker''s Shield, Heartseeker,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Amanita Charm, Breastplate of Valor, Kinetic Cuirass, Shield of the Phoenix, Shifter''s
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Hammer, Golden Blade, Breastplate of Valor, Eye of the Storm, Gluttonous Grimoire,
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Splitter, Spear of Desolation, Spear of the Magus, Breastplate of Valor, Runeforged
