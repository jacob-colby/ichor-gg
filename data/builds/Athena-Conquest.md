...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Shield, Daybreak Gavel, Soul Gem, Doublet of Binding, Shifter''s Shield.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.58
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Pridwen, Eye of the Storm, Lifebinder, Midgardian Mail, Stone of Binding, Hide
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Gavel, Hide of the Nemean Lion, Rod of Asclepius, Leviathan''s Hide, Shifter''s
    Shield.'
  slot_scores:
    Stone of Binding:
      total: 0.58
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Tekko-Kagi, Rod of Asclepius, Avenging Blade, Shifter''s Shield.'
  slot_scores:
    Golden Blade:
      total: 0.55
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gargoyle, Soul Gem, Shield Splitter, Chronos'' Pendant, Berserker''s Shield, Prophetic
    ...
    Gavel, Chandra''s Grace, Obsidian Shard, Hide of the Nemean Lion, Leviathan''s
    Hide, Jade Scepter, Void Shield, Shifter''s Shield.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.61
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Blade, Eye of the Storm, Gluttonous Grimoire, Heartseeker, Tyrfing, Lernaean Bow,
    Erosion, Spear of Desolation, Tekko-Kagi, Spear of the Magus, Eye of Providence,
    ...
    Shogun''s Ofuda, Screeching Gargoyle, Mantle Of Discord, Midgardian Mail, Shifter''s
    Shield.'
  slot_scores:
    Berserker's Shield:
      total: 0.58
