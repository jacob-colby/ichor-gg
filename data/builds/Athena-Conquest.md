...
- source: community
  ...
  god_win_rate: 0.5487132352941176
  god_matches_won: 597
  god_matches_played: 1088
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Shifter''s Shield, Jotunn''s Revenge, Breastplate of Valor,
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Runeforged Hammer, Golden Blade, Shifter''s Shield, Eye of the Storm, Gluttonous
...
- source: suggested
  ...
  - added: Spirit Robe
    ...
    reason: community 69% win over 54 matches (vs 55% on this god), taking the model's
