...
- source: community
  ...
  god_win_rate: 0.5613608748481167
  god_matches_won: 462
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Shifter''s Shield, Jotunn''s Revenge, Soul Gem, Berserker''s
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Shield, Breastplate of Valor, Shield Splitter, Soul Gem, Runeforged Hammer, Pharaoh''s
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Shifter''s Shield, Obsidian Shard, Breastplate of Valor, Berserker''s Shield,
...
- source: suggested
  ...
  - added: Shell of Rebuke
    ...
    reason: community 66% win over 107 matches (vs 56% on this god), taking the model's
