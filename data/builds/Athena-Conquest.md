...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Soul Gem, Doublet of Binding, Shifter''s Shield, Hydra''s Lament.'
  slot_scores:
    Breastplate of Valor:
      total: 0.69
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Tekko-Kagi, Rod of Asclepius, Avenging Blade, Hydra''s Lament, Shifter''s Shield.'
  slot_scores:
    Golden Blade:
      total: 0.64
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shield, Hydra''s Lament, Shifter''s Shield.'
  slot_scores:
    Genji's Guard:
      total: 0.66
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Idol, Midgardian Mail, Hydra''s Lament, Shifter''s Shield.'
  slot_scores:
    Book of Thoth:
      total: 0.6
      efficiency: 0.51
