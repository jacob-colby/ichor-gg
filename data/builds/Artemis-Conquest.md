...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Titan''s Bane, The Crusher, Lernaean Bow, Avenging Blade, Hydra''s Lament, Deathbringer,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Toxic Blade, Jotunn''s Revenge, Lernaean Bow, Golden Blade, Tekko-Kagi,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shield, Rage, Avenging Blade, Eye of Erebus, Barbed Carver, Golden Blade, Avatar''s
    Parashu, Daybreak Gavel.'
  slot_scores:
    Lernaean Bow:
      total: 0.5
      efficiency: 0.52
...
- source: suggested
  ...
  - added: Tyrfing
    removed: The Reaper
    reason: community 61% win over 1,065 matches (vs 57% on this god), taking the
      model's weakest slot from The Reaper
  starter: *id001
---
