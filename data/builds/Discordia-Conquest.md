...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Gluttonous
    ...
    the Magus, Breastplate of Valor, Bragi''s Harp, The World Stone, Bancroft''s Talon,
...
- source: suggested
  ...
  - added: Soul Reaver
    ...
    reason: community 74% win over 42 matches (vs 54% on this god), taking the model's
      weakest slot from Obsidian Shard
  - added: Soul Gem
    removed: Spear of the Magus
    reason: community 69% win over 61 matches (vs 54% on this god), taking the model's
