...
- source: community
  ...
  god_win_rate: 0.4491017964071856
  god_matches_won: 75
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    for this god: Rod of Tahuti, Obsidian Shard, Amanita Charm, Stone of Binding,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Grimoire, Breastplate of Valor, Obsidian Shard, Shifter''s Shield, Soul Gem, Helm
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Shield, Amanita Charm, Kinetic Cuirass, Obsidian Shard, Shield Splitter, Golden
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Obsidian Shard, Amanita Charm, Kinetic Cuirass, Gluttonous Grimoire, Breastplate
    ...
    Providence, Shield of the Phoenix, Stone of Binding, Draconic Scale, Chronos''
    Pendant, Doom Orb, Jade Scepter, Death Metal, Wish-Granting Pearl, Avenging Blade,
