...
- source: community
  ...
  god_win_rate: 0.4472573839662447
  god_matches_won: 212
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Mail, Rod of Asclepius, Hide of the Nemean Lion, Breastplate of Valor.'
  slot_scores:
    Screeching Gargoyle:
      total: 0.51
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gem, Chronos'' Pendant, Shifter''s Shield, Breastplate of Valor, Prophetic Cloak,
...
- source: suggested
  ...
  - added: Shell of Rebuke
    ...
    reason: community 67% win over 52 matches (vs 45% on this god), taking the model's
