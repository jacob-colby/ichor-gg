...
- source: community
  ...
  god_win_rate: 0.5402843601895735
  god_matches_won: 114
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Rod
    ...
    Nimble Ring, Soul Gem, Spear of the Magus, Book of Thoth, Obsidian Shard, Heartseeker,
    ...
    The Reaper, Arondight, Gem of Focus, Pendulum Blade, Runeforged Hammer, Musashi''s
    Dual Swords, Soul Reaver, Avatar''s Parashu, Rod of Asclepius, The Cosmic Horror,
    Demon Blade, Polynomicon.'
  slot_scores:
    Book of Thoth:
      total: 0.5
      efficiency: 0.51
...
- source: suggested
  ...
  - added: Silverbranch Bow
    ...
    reason: community 69% win over 51 matches (vs 54% on this god), taking the model's
