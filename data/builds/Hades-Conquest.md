...
- source: community
  ...
  god_win_rate: 0.6137339055793991
  god_matches_won: 286
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    god: Gluttonous Grimoire, Soul Gem, Spear of Desolation, Genji''s Guard, The Cosmic
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Kinetic Cuirass, Rod of Asclepius, Genji''s Guard, Bancroft''s Talon, Spear of
    Desolation, Chandra''s Grace, Nimble Ring, Blood-Bound Book, Oni Hunter''s Garb,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Eye of Providence, Erosion, Obsidian Shard.'
  slot_scores:
    Genji's Guard:
      total: 0.56
      efficiency: 0.69
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Spear of Desolation, Amanita Charm, Runeforged Hammer, Hydra''s Lament, Death
    ...
    Pendant, Tekko-Kagi, Jade Scepter, Tyrfing, Riptalon, Erosion, Obsidian Shard,
    Shifter''s Shield.'
  slot_scores:
    Book of Thoth:
      total: 0.5
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Eye of the Storm, Helm of Radiance, Shield Splitter, Chronos'' Pendant, Golden
    Blade, Jade Scepter, Triton''s Conch, Spectral Armor, Avenging Blade, Damaru,
    Obsidian Shard, Ethereal Staff, Erosion, Bragi''s Harp, Alchemist Coat, Pharaoh''s
