...
- source: community
  ...
  god_win_rate: 0.46360153256704983
  god_matches_won: 121
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Daybreak Gavel, Bloodforge, Genji''s Guard.'
  slot_scores:
    Ashwhorl Acorn:
      total: 0.55
      efficiency: 0.7
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Genji''s Guard, The Crusher, The Reaper, Avatar''s Parashu, Eye of Erebus, Transcendence,
