...
- source: community
  ...
  god_win_rate: 0.5980707395498392
  god_matches_won: 186
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Grimoire, Mantle Of Discord, Midgardian Mail, Stampede, Screeching Gargoyle, Helm
    of Darkness, Leviathan''s Hide, Void Shield, Ancile, Oni Hunter''s Garb, Prophetic
    Cloak, Xibalban Effigy, Spear of Desolation, Hussar''s Wings, Breastplate of Valor.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.58
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Soul Gem, Erosion, Eye of Providence, Gluttonous Grimoire, Phoenix
    Feather, Yogi''s Necklace, Chandra''s Grace, Glorious Pridwen, Lifebinder, Midgardian
    Mail, Stone of Binding, Stampede, Helm of Radiance, Leviathan''s Hide, Void Shield,
    Magi''s Cloak, Ancile, Breastplate of Valor.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.58
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Idol, Magi''s Cloak, Mantle Of Discord, Midgardian Mail, Rod of Asclepius, Breastplate
    of Valor.'
  slot_scores:
    Stone of Binding:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gem, Chronos'' Pendant, Erosion, Helm of Radiance, Gluttonous Grimoire, Prophetic
    Cloak, Eye of Providence, Gladiator''s Shield, Stone of Binding, Gem of Focus,
    Magi''s Cloak, Rod of Asclepius, Eye of Erebus, Spear of the Magus, Breastplate
    of Valor, Mantle Of Discord, Glorious Pridwen, Midgardian Mail, Daybreak Gavel.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.54
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Ofuda, Screeching Gargoyle, Mantle Of Discord, Midgardian Mail, Breastplate of
    Valor.'
  slot_scores:
    Berserker's Shield:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Idol, Midgardian Mail, Breastplate of Valor.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.57
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Void Shield, Stampede, Ancile, Oni Hunter''s Garb, Xibalban Effigy, Spear of Desolation,
    Hussar''s Wings.'
  slot_scores:
    Breastplate of Valor:
      total: 0.48
