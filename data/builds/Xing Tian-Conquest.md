...
- source: community
  ...
  god_win_rate: 0.5653798256537983
  god_matches_won: 454
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Shield of the Phoenix, Stampede, Stone of Binding, Magi''s Cloak,
    ...
    Oni Hunter''s Garb, Xibalban Effigy, Spear of Desolation, Hussar''s Wings, Hide
    of the Nemean Lion.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.58
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Staff, Stampede, Gluttonous Grimoire, Phoenix Feather, Yogi''s Necklace, Chandra''s
    Grace, Glorious Pridwen, Lifebinder, Midgardian Mail, Stone of Binding, Helm of
    Radiance, Leviathan''s Hide, Void Shield, Magi''s Cloak, Ancile, Hide of the Nemean
    Lion.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.57
...
- source: suggested
  ...
  - added: Shell of Rebuke
    ...
    reason: community 66% win over 104 matches (vs 57% on this god), taking the model's
