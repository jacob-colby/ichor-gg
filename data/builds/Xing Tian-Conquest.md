...
- source: community
  ...
  god_win_rate: 0.5753424657534246
  god_matches_won: 42
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Breastplate of Valor, Shield of the Phoenix, Rod of Tahuti,
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    win/pick). Underrated for this god: Rod of Tahuti, Breastplate of Valor, Jotunn''s
    ...
    Titan''s Bane, Silverbranch Bow, The Crusher, Pharaoh''s Curse, Magi''s Cloak,
    Nimble Ring, Toxic Blade, The Reaper, Shogun''s Ofuda, Screeching Gargoyle, Mantle
