...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Gargoyle, Stampede, Prophetic Cloak, Helm of Darkness, Leviathan''s Hide, Void
    Shield, Ancile, Oni Hunter''s Garb, Xibalban Effigy, Spear of Desolation, Hussar''s
    Wings, Breastplate of Valor.'
  slot_scores:
    Eye of Providence:
      total: 0.55
      efficiency: 0.61
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Lifebinder, Midgardian Mail, Stone of Binding, Helm of Radiance, Stampede, Leviathan''s
    Hide, Void Shield, Magi''s Cloak, Ancile, Breastplate of Valor.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.59
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Mantle Of Discord, Glorious Pridwen, Midgardian Mail, Daybreak Gavel, Breastplate
    of Valor.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.55
