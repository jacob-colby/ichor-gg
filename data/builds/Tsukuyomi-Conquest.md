...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    Underrated for this god: The Crusher, Tekko-Kagi, The Reaper, Tyrfing, Lernaean
    Bow, Hydra''s Lament, Golden Blade, Runeforged Hammer, Damaru, Avenging Blade,
    Rage, Shield Splitter, Demon Blade, Pendulum Blade, Eye of the Storm, Berserker''s
    Shield, Musashi''s Dual Swords, Spectral Armor, Eros'' Bow, Pharaoh''s Curse,
    Kinetic Cuirass, Riptalon, Arondight, Eye of Providence.'
  slot_scores:
    Lernaean Bow:
      total: 0.44
      efficiency: 0.36
