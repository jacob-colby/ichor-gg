...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Dominance, The Cosmic Horror, Musashi''s Dual Swords, Runeforged Hammer, Rod of
...
- source: suggested
  ...
  rationale: 'Off-type Intelligence build — this kit scales on it (efficiency + fit
    ...
    Polynomicon, Totem of Death, Blood-Bound Book, Musashi''s Dual Swords.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.61
      efficiency: 0.72
...
- source: suggested
  ...
  - added: Avatar's Parashu
    ...
    reason: community 76% win over 54 matches (vs 54% on this god), taking the model's
