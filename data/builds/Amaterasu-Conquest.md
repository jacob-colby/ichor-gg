...
- source: community
  ...
  god_win_rate: 0.5926680244399185
  god_matches_won: 291
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gladiator''s Shield, Stone of Binding, Chronos'' Pendant, Eye of the Storm, Arondight,
...
- source: suggested
  ...
  rationale: 'Off-type Intelligence build — this kit scales on it (efficiency + fit
    ...
    Avenging Blade, Chronos'' Pendant, Ethereal Staff, Triton''s Conch, Daybreak Gavel,
    Mantle Of Discord.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.6
...
- source: suggested
  ...
  - added: Golden Blade
    ...
    reason: community 69% win over 137 matches (vs 59% on this god), taking the model's
