...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Glorious Pridwen, Freya''s Tears.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.5
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Ruin, Helm of Radiance, Daybreak Gavel, Book of Thoth.'
  slot_scores:
    Bracer of The Abyss:
      total: 0.46
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Grace, Polynomicon, Blood-Bound Book, Soul Reaver, Jade Scepter, Book of Thoth,
    Freya''s Tears.'
  slot_scores:
    Chronos' Pendant:
      total: 0.53
