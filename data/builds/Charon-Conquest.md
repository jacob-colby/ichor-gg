...
- source: community
  ...
  god_win_rate: 0.48114901256732495
  god_matches_won: 268
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Shield of the Phoenix, Prophetic Cloak, Stone of Binding, Magi''s
    Cloak, Helm of Radiance, Gluttonous Grimoire, Mantle Of Discord, Midgardian Mail,
    Screeching Gargoyle, Shifter''s Shield, Hide of the Nemean Lion, Helm of Darkness,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Cuirass, Shield of the Phoenix, Prophetic Cloak, Spear of Desolation, Screeching
    Gargoyle, Soul Gem, Erosion, Helm of Radiance, Gluttonous Grimoire, Eye of Providence,
    ...
    Pridwen, Midgardian Mail, Daybreak Gavel, Chronos'' Pendant, Shifter''s Shield.'
  slot_scores:
    Genji's Guard:
      total: 0.55
      efficiency: 0.66
