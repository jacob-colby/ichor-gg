...
- source: community
  ...
  god_win_rate: 0.5253863134657837
  god_matches_won: 238
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Stone of Binding, Gluttonous Grimoire, Obsidian Shard, Kinetic Cuirass, Screeching
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Splitter, Runeforged Hammer, Golden Blade, Obsidian Shard, Gluttonous Grimoire,
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Revenge, Shifter''s Shield, Amanita Charm, Kinetic Cuirass, Obsidian Shard, Gluttonous
