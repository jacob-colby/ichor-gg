...
- source: community
  ...
  god_win_rate: 0.5045871559633027
  god_matches_won: 165
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Lifebinder, Soul Gem, Gluttonous Grimoire, Chandra''s Grace, Rod of Asclepius,
    Freya''s Tears, Oni Hunter''s Garb, Erosion, Eye of Providence, Draconic Scale,
    Phoenix Feather, Breastplate of Valor, Spectral Armor, Leviathan''s Hide, Midgardian
    Mail, Glorious Pridwen, Nimble Ring, Gladiator''s Shield, Ancile, Blood-Bound
    Book, Hide of the Nemean Lion.'
  slot_scores:
    Genji's Guard:
      total: 0.56
      efficiency: 0.69
