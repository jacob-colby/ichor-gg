...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Shifter''s Shield, Shield of the Phoenix, Stone of Binding, Magi''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Staff, Shifter''s Shield, Gluttonous Grimoire, Phoenix Feather, Yogi''s Necklace,
    Lifebinder, Glorious Pridwen, Midgardian Mail, Stone of Binding, Helm of Radiance,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Draconic Scale, Shield of the Phoenix, Doom Orb, Shifter''s Shield, Helm of Radiance,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Shield of the Phoenix, Draconic Scale, Magi''s Cloak, Shifter''s Shield, Screeching
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gladiator''s Shield, Draconic Scale, Stone of Binding, Shifter''s Shield, Gem
    of Focus, Magi''s Cloak, Rod of Asclepius, Eye of Erebus, Spear of the Magus,
    Mantle Of Discord, Glorious Pridwen, Midgardian Mail, Daybreak Gavel, Chronos''
    Pendant.'
  slot_scores:
    Genji's Guard:
      total: 0.62
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Shifter''s Shield, Pharaoh''s Curse, Magi''s Cloak, Nimble Ring, Silverbranch
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    of Binding, Draconic Scale, Doom Orb, Jade Scepter, Shifter''s Shield, Death Metal,
    ...
    Dreamer''s Idol, Midgardian Mail, Chronos'' Pendant.'
  slot_scores:
    Genji's Guard:
      total: 0.58
      efficiency: 0.66
