...
- source: community
  ...
  god_win_rate: 0.48774795799299886
  god_matches_won: 418
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shield, Screeching Gargoyle, Soul Gem, Prophetic Cloak, Chronos'' Pendant, Erosion,
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    of Valor, Shifter''s Shield, Golden Blade, Gluttonous Grimoire, Eye of the Storm,
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    of Valor, Shifter''s Shield, Spear of Desolation, Spear of the Magus, Runeforged
    ...
    Mantle Of Discord, Dreamer''s Idol, Midgardian Mail, Chronos'' Pendant.'
  slot_scores:
    Breastplate of Valor:
      total: 0.48
      efficiency: 0.65
