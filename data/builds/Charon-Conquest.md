...
- source: community
  ...
  god_win_rate: 0.4858757062146893
  god_matches_won: 172
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Radiance, Gluttonous Grimoire, Mantle Of Discord, Shifter''s Shield, Midgardian
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Lifebinder, Soul Gem, Erosion, Eye of Providence, Draconic Scale,
    ...
    Shifter''s Shield, Hide of the Nemean Lion, Leviathan''s Hide, Void Shield, Stampede,
    Magi''s Cloak, Ancile.'
  slot_scores:
    Genji's Guard:
      total: 0.55
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    of Binding, Draconic Scale, Chronos'' Pendant, Doom Orb, Jade Scepter, Death Metal,
