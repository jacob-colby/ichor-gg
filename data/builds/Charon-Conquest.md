...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Scale, Spectral Armor, Prophetic Cloak, Soul Gem, Leviathan''s Hide, Mantle Of
    Discord, Stone of Binding, Hide of the Nemean Lion, Midgardian Mail, Helm of Radiance,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Erosion, Lifebinder, Eye of Providence, Draconic Scale, Phoenix Feather, Spectral
    Armor, Leviathan''s Hide, Blood-Bound Book, Bancroft''s Talon, Midgardian Mail,
    Glorious Pridwen, Gladiator''s Shield, Ancile, Helm of Radiance, Jade Scepter.'
  slot_scores:
    Genji's Guard:
      total: 0.52
      efficiency: 0.71
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Metal, Erosion, Spectral Armor, Spear of the Magus, Eye of Providence, Damaru,
    ...
    Stone of Binding, Heartseeker, Tekko-Kagi, Spear of Desolation.'
  slot_scores:
    Berserker's Shield:
      total: 0.52
      efficiency: 0.68
