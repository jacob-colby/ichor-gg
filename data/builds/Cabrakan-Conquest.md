...
- source: community
  ...
  god_win_rate: 0.5661691542288557
  god_matches_won: 569
  god_matches_played: 1005
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Erosion, Draconic Scale, Spectral Armor, Pharaoh''s Curse, Soul Gem, Avenging
    Blade, Golden Blade, Yogi''s Necklace, Leviathan''s Hide, Death Metal, Hide of
    the Nemean Lion, Midgardian Mail, Mantle Of Discord, Stone of Binding, Lernaean
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Hide, Death Metal, Hide of the Nemean Lion, Midgardian Mail, Riptalon, Lernaean
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Hide, Hide of the Nemean Lion, Jade Scepter, Midgardian Mail, Spear of the Magus,
    Mantle Of Discord.'
  slot_scores:
    Genji's Guard:
      total: 0.58
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Revenge, Amanita Charm, Kinetic Cuirass, Gluttonous Grimoire, Eye of Providence,
