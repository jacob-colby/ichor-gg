...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Splitter, Eye of the Storm, Stampede, Berserker''s Shield, Erosion, Eye of Providence,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Stampede, Berserker''s Shield, Erosion, Ethereal Staff, Eye of Providence, The
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    + fit + win/pick). Underrated for this god: Gladiator''s Shield, Rod of Tahuti,
    ...
    Gluttonous Grimoire, Eye of Providence, Draconic Scale, Stone of Binding, Eye
