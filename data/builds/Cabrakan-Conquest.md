...
- source: community
  ...
  god_win_rate: 0.47635135135135137
  god_matches_won: 141
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Gem, Spear of the Magus, Stampede.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.51
      efficiency: 0.72
...
- source: suggested
  ...
  - added: Genji's Guard
    ...
    reason: community 62% win over 53 matches (vs 48% on this god), taking the model's
