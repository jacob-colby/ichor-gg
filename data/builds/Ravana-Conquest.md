...
- source: community
  ...
  god_win_rate: 0.4625382262996942
  god_matches_won: 605
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Freya''s Tears, Titan''s Bane, Runeforged Hammer, Kinetic
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Freya''s
    ...
    Binding, Draconic Scale, Pendulum Blade, Midgardian Mail.'
  slot_scores:
    Genji's Guard:
      total: 0.48
      efficiency: 0.66
