...
- source: community
  ...
  god_win_rate: 0.4734473447344735
  god_matches_won: 526
  god_matches_played: 1111
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Golden Blade, Screeching Gargoyle, Stone of Binding, Hide of the Nemean Lion,
    Avatar''s Parashu.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Freya''s
    Tears, Amanita Charm, Genji''s Guard, Breastplate of Valor, Titan''s Bane, Hydra''s
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Avatar''s Parashu, Stone of Binding, Midgardian Mail, Hide of the Nemean Lion,
    Leviathan''s Hide.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Runeforged Hammer, Shield Splitter, Titan''s Bane, Genji''s Guard, Breastplate
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    for this god: Titan''s Bane, Avenging Blade, Freya''s Tears, Amanita Charm, Screeching
    ...
    Phoenix, Tekko-Kagi, Erosion, Eye of Providence, Draconic Scale, Arondight.'
  slot_scores:
    Avenging Blade:
      total: 0.51
      efficiency: 0.49
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Screeching Gargoyle, Titan''s Bane, Runeforged Hammer, Berserker''s Shield, Arondight,
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Bane, Erosion, Eye of Providence, Draconic Scale, Pendulum Blade, Arondight, Midgardian
