...
- source: community
  ...
  god_win_rate: 0.479111581173982
  god_matches_won: 906
  god_matches_played: 1891
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Blade, Screeching Gargoyle, Freya''s Tears, Stone of Binding, Hide of the Nemean
    Lion.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.57
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Amanita
    ...
    Binding, Draconic Scale, Pendulum Blade, Midgardian Mail, Freya''s Tears, Hide
    of the Nemean Lion.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Daybreak Gavel, Arondight, Freya''s Tears, Erosion, Eye of Providence, Draconic
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    of Binding, Midgardian Mail, Freya''s Tears, Daybreak Gavel, The Crusher, Hide
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Erosion, Eye of Providence, Draconic Scale, Arondight, Freya''s Tears.'
  slot_scores:
    Avenging Blade:
      total: 0.5
      efficiency: 0.49
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gargoyle, Freya''s Tears, Runeforged Hammer, Berserker''s Shield, Arondight, Gladiator''s
...
- source: suggested
  ...
  - added: Titan's Bane
    ...
    reason: community 58% win over 132 matches (vs 48% on this god), taking the model's
      weakest slot from Shield Splitter
  - added: The Reaper
    removed: Freya's Tears
    reason: community 55% win over 246 matches (vs 48% on this god), taking the model's
