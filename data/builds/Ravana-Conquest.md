...
- source: community
  ...
  god_win_rate: 0.46981891348088534
  god_matches_won: 467
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Freya''s
    ...
    Scale, Pendulum Blade, Midgardian Mail, Hide of the Nemean Lion.'
  slot_scores:
    Genji's Guard:
      total: 0.49
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    for this god: Freya''s Tears, Titan''s Bane, Avenging Blade, Amanita Charm, Screeching
