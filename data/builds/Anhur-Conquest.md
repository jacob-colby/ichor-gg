...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Rage, Toxic Blade, Titan''s Bane, The Crusher, Transcendence, Arondight, Runeforged
    Hammer, Sun Beam Bow, Barbed Carver, Avatar''s Parashu, Bloodforge, Pendulum Blade,
    Deathbringer.'
  slot_scores:
    Avenging Blade:
      total: 0.56
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Jotunn''s
    ...
    Parashu, Damaru, Rage, Barbed Carver, Breastplate of Valor, Genji''s Guard, Deathbringer.'
  slot_scores:
    Avenging Blade:
      total: 0.56
      efficiency: 0.44
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Spear, Transcendence, Runeforged Hammer, Arondight, Damaru, Rage, Barbed Carver,
    Deathbringer.'
  slot_scores:
    Avenging Blade:
      total: 0.6
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    The Reaper, Hydra''s Lament, Demon Blade, Toxic Blade, Heartseeker, Musashi''s
    Dual Swords, Sun Beam Bow, Titan''s Bane, The Crusher, Transcendence, Damaru,
    Rage, Runeforged Hammer, Arondight, Barbed Carver, Vital Amplifier, Avatar''s
    Parashu, Deathbringer.'
  slot_scores:
    Avenging Blade:
      total: 0.55
      efficiency: 0.44
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Lernaean Bow, Arondight, The Reaper, Tekko-Kagi, Golden Blade, Dominance, Heartseeker,
    Pendulum Blade, Breastplate of Valor, Demon Blade, Musashi''s Dual Swords, Genji''s
    Guard, Titan''s Bane, Toxic Blade, The Crusher, Transcendence, Runeforged Hammer,
    Damaru, Rage, Sun Beam Bow, Daybreak Gavel, Deathbringer.'
  slot_scores:
    Avenging Blade:
      total: 0.54
      efficiency: 0.44
