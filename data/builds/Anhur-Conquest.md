...
- source: community
  ...
  god_win_rate: 0.4726166328600406
  god_matches_won: 233
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Tekko-Kagi, Damaru, Genji''s Guard, Lernaean Bow, Avenging Blade, Golden Blade,
...
- source: suggested
  ...
  - added: Silverbranch Bow
    ...
    reason: community 60% win over 113 matches (vs 47% on this god), taking the model's
      weakest slot from Golden Blade
  - added: The Executioner
    removed: Lernaean Bow
    reason: community 59% win over 74 matches (vs 47% on this god), taking the model's
