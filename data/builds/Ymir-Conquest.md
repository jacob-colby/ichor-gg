...
- source: community
  ...
  god_win_rate: 0.5475330926594465
  god_matches_won: 455
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Shield, Chronos'' Pendant, Prophetic Cloak, Helm of Radiance, Erosion, Eye of
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Hammer, Helm of Radiance, Soul Gem, Shifter''s Shield, Obsidian Shard, Eye of
...
- source: suggested
  ...
  - added: Shell of Rebuke
    removed: Erosion
    reason: community 67% win over 83 matches (vs 55% on this god), taking the model's
