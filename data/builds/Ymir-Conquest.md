...
- source: community
  ...
  god_win_rate: 0.5697445972495089
  god_matches_won: 290
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Pendant, Prophetic Cloak, Shifter''s Shield, Helm of Radiance, Erosion, Eye of
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Heartseeker, Tyrfing, Shifter''s Shield, Lernaean Bow, Erosion, Spear of Desolation,
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Hydra''s Lament, Rod of Asclepius, Shifter''s Shield, Heartseeker, Nimble Ring,
