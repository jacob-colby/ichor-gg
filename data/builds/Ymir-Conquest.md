...
- source: community
  ...
  god_win_rate: 0.5521739130434783
  god_matches_won: 254
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    of Valor, Golden Blade, Eye of the Storm, Gluttonous Grimoire, Shogun''s Ofuda,
    ...
    Toxic Blade, Nimble Ring, The Reaper, Screeching Gargoyle, Mantle Of Discord,
    Midgardian Mail.'
  slot_scores:
    Berserker's Shield:
      total: 0.56
