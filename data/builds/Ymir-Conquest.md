...
- source: community
  ...
  god_win_rate: 0.5745341614906833
  god_matches_won: 185
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Rod of Tahuti, Shield of the Phoenix, Kinetic Cuirass, Screeching Gargoyle, Chronos''
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Amanita Charm, Berserker''s Shield, Gluttonous Grimoire, Kinetic Cuirass, Shield
