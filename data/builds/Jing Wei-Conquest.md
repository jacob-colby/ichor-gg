...
- source: community
  ...
  god_win_rate: 0.5080213903743316
  god_matches_won: 95
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Demon Blade, Hydra''s Lament, Oath-Sworn Spear, Transcendence, Qin''s Blade, Damaru,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Hastened Fatalis, Bloodforge, Heartseeker, Daybreak Gavel.'
  slot_scores:
    Golden Blade:
      total: 0.52
      efficiency: 0.47
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Carver, Vital Amplifier, Screeching Gargoyle, Chandra''s Grace.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.55
      efficiency: 0.67
