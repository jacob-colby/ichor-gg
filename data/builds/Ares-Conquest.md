...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Gargoyle, Ancile, Prophetic Cloak, Hydra''s Lament, Shogun''s Ofuda, Void Shield,
    Helm of Radiance, Doublet of Binding, Shifter''s Shield, Chandra''s Grace, Hussar''s
    Wings.'
  slot_scores:
    Berserker's Shield:
      total: 0.58
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Pharaoh''s Curse, The Crusher, Leviathan''s Hide, Midgardian Mail, Runeforged
    Hammer, Glorious Pridwen, Eye of the Storm, Lifebinder, Gladiator''s Shield, Shield
    Splitter, Nimble Ring, Ancile, The Reaper, Blood-Bound Book, Shogun''s Ofuda,
    Void Shield, Hydra''s Lament, Doublet of Binding, Mantle Of Discord, Bancroft''s
    Talon, Shifter''s Shield.'
  slot_scores:
    Berserker's Shield:
      total: 0.59
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Silverbranch Bow, Hydra''s Lament, Mantle Of Discord, Eye of the Storm, Helm of
    Radiance, Ancile, Shifter''s Shield.'
  slot_scores:
    Stone of Binding:
      total: 0.57
      efficiency: 0.47
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Arondight, Death Metal, Rod of Asclepius, The Cosmic Horror, Shifter''s Shield.'
  slot_scores:
    Breastplate of Valor:
      total: 0.59
      efficiency: 0.64
