...
- source: community
  ...
  god_win_rate: 0.5211640211640212
  god_matches_won: 197
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Cloak, Gladiator''s Shield, Rod of Asclepius, Ancile, Stampede, Screeching Gargoyle,
    Prophetic Cloak, Doublet of Binding, Void Shield, Xibalban Effigy, Hide of the
    Nemean Lion.'
  slot_scores:
    Eye of Providence:
      total: 0.54
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Hunter''s Garb, Chandra''s Grace, Breastplate of Valor, Freya''s Tears, Erosion,
    ...
    Gladiator''s Shield, Ancile, Riptalon, Stampede, Jade Scepter, Hide of the Nemean
    Lion.'
  slot_scores:
    Genji's Guard:
      total: 0.55
