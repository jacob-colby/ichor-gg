...
- source: community
  ...
  god_win_rate: 0.582010582010582
  god_matches_won: 110
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Chandra''s Grace, Jotunn''s Revenge, Breastplate of Valor, Berserker''s Shield,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Hydra''s Lament, Chandra''s Grace, Screeching Gargoyle, Berserker''s Shield, Shield
    Splitter, Prophetic Cloak, Runeforged Hammer, Gladiator''s Shield, Erosion, Eye
    of Providence, Arondight, Draconic Scale, Eye of the Storm, Stone of Binding,
