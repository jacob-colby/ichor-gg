...
- source: community
  ...
  god_win_rate: 0.6242118537200504
  god_matches_won: 495
  god_matches_played: 793
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Berserker''s Shield, Draconic Scale, Jotunn''s Revenge, Amanita Charm,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    + fit + win/pick). Underrated for this god: Jotunn''s Revenge, Draconic Scale,
...
- source: suggested
  ...
  - added: Draconic Scale
    ...
    reason: community 81% win over 40 matches (vs 62% on this god), taking the model's
