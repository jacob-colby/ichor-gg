...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Lion, Gladiator''s Shield, Leviathan''s Hide, Void Shield, Stampede, Ancile, Oni
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Lion, Gladiator''s Shield, Leviathan''s Hide, Void Shield, Magi''s Cloak, Stampede,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Daybreak Gavel, Mantle Of Discord, Hide of the Nemean Lion, Avenging Blade.'
  slot_scores:
    Genji's Guard:
      total: 0.57
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Draconic Scale, Stone of Binding, Eye of the Storm, Screeching Gargoyle, Magi''s
