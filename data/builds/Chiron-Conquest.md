...
- source: community
  ...
  god_win_rate: 0.5171957671957672
  god_matches_won: 391
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Phoenix Feather, Eye of the Storm, Tekko-Kagi, Toxic Blade, Erosion, Eye of Providence,
    Daybreak Gavel.'
  slot_scores:
    Berserker's Shield:
      total: 0.53
...
- source: suggested
  ...
  - added: Avatar's Parashu
    ...
    reason: community 84% win over 53 matches (vs 52% on this god), taking the model's
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Carver, Breastplate of Valor, Genji''s Guard, Bloodforge, Daybreak Gavel.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.58
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Damaru, Rage, Dominance, Toxic Blade, Demon Blade, Avenging Blade, Eye of Erebus,
