...
- source: community
  ...
  god_win_rate: 0.47634069400630913
  god_matches_won: 151
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Harp, Tekko-Kagi, Daybreak Gavel, Spear of Desolation, Heartseeker, Rod of Asclepius,
    Leviathan''s Hide, Void Shield, Stampede, Ancile, Avenging Blade.'
  slot_scores:
    Genji's Guard:
      total: 0.52
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Revenge, Berserker''s Shield, Breastplate of Valor, Amanita Charm, Eye of Erebus,
