...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Runeforged Hammer, Genji''s Guard, Breastplate of Valor, Shield Splitter, Yogi''s
    Necklace, Eye of the Storm, Pharaoh''s Curse, The Reaper, Lernaean Bow, Erosion,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    of the Storm, Arondight, Gem of Focus, Lernaean Bow, Spear of the Magus, Eye of
    Erebus, Magi''s Cloak, Rod of Asclepius, Daybreak Gavel, Mantle Of Discord, Obsidian
    Shard, Midgardian Mail, Tyrfing.'
  slot_scores:
    Genji's Guard:
      total: 0.59
      efficiency: 0.66
