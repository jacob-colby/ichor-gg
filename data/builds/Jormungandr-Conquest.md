...
- source: community
  ...
  god_win_rate: 0.5053763440860215
  god_matches_won: 47
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Avenging Blade, The Crusher, Eye of the Storm, Hydra''s Lament, Lernaean Bow,
    Erosion, Nimble Ring, Pharaoh''s Curse, The Reaper, Helm of Radiance, Eye of Providence,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Revenge, Berserker''s Shield, Genji''s Guard, Breastplate of Valor, Amanita Charm,
