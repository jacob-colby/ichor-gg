...
- source: community
  ...
  god_win_rate: 0.6825396825396826
  god_matches_won: 43
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Void Shield, Stampede, Ancile, Leviathan''s Hide.'
  slot_scores:
    Berserker's Shield:
      total: 0.63
      efficiency: 0.68
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    + fit + win/pick). Underrated for this god: Rod of Tahuti, Eye of Erebus, Jotunn''s
    ...
    Rod of Asclepius, Daybreak Gavel, Mantle Of Discord, Obsidian Shard, Midgardian
    Mail, Tyrfing.'
  slot_scores:
    Genji's Guard:
      total: 0.61
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Revenge, Shield Splitter, Genji''s Guard, Breastplate of Valor, Golden Blade,
