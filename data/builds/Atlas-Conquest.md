...
- source: community
  ...
  god_win_rate: 0.5239852398523985
  god_matches_won: 142
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Shield of the Phoenix, Rod of Tahuti, Yogi''s Necklace,
    ...
    Feather, Chandra''s Grace, Glorious Pridwen, Ethereal Staff, Lifebinder, Midgardian
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gargoyle, Soul Gem, Prophetic Cloak, Shifter''s Shield, Chronos'' Pendant, Erosion,
