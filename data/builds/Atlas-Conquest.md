...
- source: community
  ...
  god_win_rate: 0.5275735294117647
  god_matches_won: 287
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Prophetic Cloak, Midgardian Mail, Screeching Gargoyle, Helm of Darkness, Leviathan''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Yogi''s Necklace, Rod of Asclepius, Shifter''s Shield, Soul Gem, Erosion, Eye
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gargoyle, Soul Gem, Shifter''s Shield, Prophetic Cloak, Chronos'' Pendant, Erosion,
