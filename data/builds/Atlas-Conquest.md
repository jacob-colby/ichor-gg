...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Leviathan''s Hide, Amanita Charm, Rod of Tahuti, Kinetic Cuirass, Shifter''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Leviathan''s Hide, Shield of the Phoenix, Rod of Tahuti,
    ...
    Feather, Yogi''s Necklace, Chandra''s Grace, Ethereal Staff, Glorious Pridwen,
    Lifebinder, Midgardian Mail, Stone of Binding, Helm of Radiance, Hide of the Nemean
    Lion, Void Shield, Magi''s Cloak, Ancile.'
  slot_scores:
    Genji's Guard:
      total: 0.56
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Leviathan''s Hide, Rod of Tahuti, Amanita Charm, Nimble Ring, Kinetic
