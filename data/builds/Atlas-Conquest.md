...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Mail, Screeching Gargoyle, Helm of Darkness, Leviathan''s Hide, Void Shield, Ancile,
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Rod of Asclepius, Shifter''s Shield, Soul Gem, Erosion, Eye of Providence, Yogi''s
    Necklace, Breastplate of Valor, Gluttonous Grimoire, Phoenix Feather, Chandra''s
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Soul Gem, Void Shield, Obsidian Shard, Shifter''s Shield, Void Stone, Breastplate
    of Valor, Erosion, Eye of Providence, Shield of the Phoenix, Doom Orb, Helm of
