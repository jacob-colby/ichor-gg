...
- source: community
  ...
  god_win_rate: 0.5440494590417311
  god_matches_won: 352
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    of Desolation, Hussar''s Wings, Stampede.'
  slot_scores:
    Genji's Guard:
      total: 0.54
      efficiency: 0.66
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Draconic Scale, Gluttonous Grimoire, Phoenix Feather, Yogi''s Necklace, Chandra''s
    Grace, Glorious Pridwen, Lifebinder, Midgardian Mail, Stone of Binding, Ethereal
    Staff, Helm of Radiance, Hide of the Nemean Lion, Leviathan''s Hide, Void Shield,
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Kinetic Cuirass, Breastplate of Valor, Screeching Gargoyle, Spear of Desolation,
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    this god: Rod of Tahuti, Amanita Charm, Nimble Ring, Breastplate of Valor, Kinetic
