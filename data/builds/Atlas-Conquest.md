...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Rod of Tahuti, Ancile, Kinetic Cuirass, Shifter''s Shield,
    ...
    of the Nemean Lion, Helm of Darkness, Leviathan''s Hide, Void Shield, Oni Hunter''s
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    this god: Amanita Charm, Ancile, Shield of the Phoenix, Rod of Tahuti, Kinetic
    Cuirass, Rod of Asclepius, Shifter''s Shield, Soul Gem, Erosion, Eye of Providence,
    Breastplate of Valor, Draconic Scale, Gluttonous Grimoire, Phoenix Feather, Yogi''s
