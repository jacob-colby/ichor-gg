...
- source: community
  ...
  god_win_rate: 0.5382113821138211
  god_matches_won: 331
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Splitter, Runeforged Hammer, Daybreak Gavel, Eye of the Storm, Berserker''s Shield,
    Erosion, Eye of Providence, Shield of the Phoenix, Hydra''s Lament, Stone of Binding,
    Gluttonous Grimoire, Avenging Blade, Helm of Radiance, Magi''s Cloak, Draconic
    Scale, Midgardian Mail, Mantle Of Discord, Screeching Gargoyle, Hide of the Nemean
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Kinetic Cuirass, Rod of Asclepius, Runeforged Hammer, Daybreak Gavel, Shield Splitter,
    Soul Gem, Eye of the Storm, Berserker''s Shield, Erosion, Ethereal Staff, Eye
    of Providence, The Reaper, Yogi''s Necklace, Phoenix Feather, Hydra''s Lament,
    Gluttonous Grimoire, Avenging Blade, Chandra''s Grace, Glorious Pridwen, Lifebinder,
    Stone of Binding, Midgardian Mail, Helm of Radiance, Draconic Scale, Hide of the
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    of Desolation, Heartseeker, Daybreak Gavel, Spear of the Magus, Void Shield, Soul
    ...
    Midgardian Mail, Mantle Of Discord, Rod of Asclepius, Draconic Scale.'
  slot_scores:
    Stone of Binding:
      total: 0.52
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Nimble Ring, Kinetic Cuirass, Golden Blade, Daybreak Gavel, Gluttonous Grimoire,
    ...
    Blade, Midgardian Mail, Mantle Of Discord, Draconic Scale.'
  slot_scores:
    Golden Blade:
      total: 0.5
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Lament, Soul Gem, Screeching Gargoyle, Daybreak Gavel, Chronos'' Pendant, Berserker''s
    ...
    Wish-Granting Pearl, Avenging Blade, Draconic Scale.'
  slot_scores:
    Breastplate of Valor:
      total: 0.54
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Shield, Amanita Charm, Kinetic Cuirass, Shield Splitter, Runeforged Hammer, Daybreak
    Gavel, Golden Blade, Eye of the Storm, Gluttonous Grimoire, Hydra''s Lament, Heartseeker,
    Lernaean Bow, Tekko-Kagi, Spear of Desolation, Tyrfing, Avenging Blade, Spear
    of the Magus, Erosion, Titan''s Bane, Eye of Providence, Shield of the Phoenix,
    ...
    Screeching Gargoyle, Bragi''s Harp, Toxic Blade, Draconic Scale.'
  slot_scores:
    Berserker's Shield:
      total: 0.53
      efficiency: 0.68
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    of Darkness, Screeching Gargoyle, Draconic Scale.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.55
      efficiency: 0.72
