...
- source: community
  ...
  god_win_rate: 0.5436681222707423
  god_matches_won: 498
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Eye of the Storm, Berserker''s Shield, Erosion, Ethereal Staff, Chandra''s Grace,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Focus, Draconic Scale, Eye of the Storm, Stone of Binding, Chandra''s Grace, Eye
    of Erebus, Rod of Asclepius, Spear of the Magus, Magi''s Cloak, Midgardian Mail,
    Glorious Pridwen, Obsidian Shard, Mantle Of Discord, Jade Scepter, Wish-Granting
    Pearl, Avenging Blade.'
  slot_scores:
    Genji's Guard:
      total: 0.55
      efficiency: 0.66
...
- source: suggested
  ...
  - added: Shell of Rebuke
    ...
    reason: community 65% win over 128 matches (vs 54% on this god), taking the model's
