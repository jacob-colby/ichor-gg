...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Hide, Void Shield, Ancile, Genji''s Guard.'
  slot_scores:
    Breastplate of Valor:
      total: 0.4
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Phoenix Feather, Yogi''s Necklace, Glorious Pridwen, Helm of Radiance, Sphere
    of Negation, Stone of Binding, Midgardian Mail, Screeching Gargoyle, Jade Scepter,
    Wish-Granting Pearl, Hide of the Nemean Lion, Genji''s Guard.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.42
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Of Discord, Midgardian Mail, Genji''s Guard.'
  slot_scores:
    Screeching Gargoyle:
      total: 0.39
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Mail, Mantle Of Discord, Jade Scepter, Genji''s Guard.'
  slot_scores:
    Bracer of The Abyss:
      total: 0.33
      efficiency: 0.52
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gem, Shifter''s Shield, Prophetic Cloak, Erosion, Helm of Radiance, Gluttonous
    ...
    Mantle Of Discord, Glorious Pridwen, Midgardian Mail, Daybreak Gavel, Genji''s
    Guard.'
  slot_scores:
    Breastplate of Valor:
      total: 0.41
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Gavel, Shogun''s Ofuda, Genji''s Guard.'
  slot_scores:
    Berserker's Shield:
      total: 0.4
      efficiency: 0.68
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    Stone of Binding, Draconic Scale, Jade Scepter, Doom Orb, Death Metal, Wish-Granting
    ...
    Gavel, Dreamer''s Idol, Genji''s Guard.'
  slot_scores:
    Chronos' Pendant:
      total: 0.39
      efficiency: 0.55
