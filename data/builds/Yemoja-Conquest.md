...
- source: community
  ...
  god_win_rate: 0.4955357142857143
  god_matches_won: 111
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Magus, Obsidian Shard, Breastplate of Valor, Void Shield, Void Stone, Shifter''s
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Harp, Obsidian Shard, Magi''s Cloak, Daybreak Gavel, Bracer of The Abyss, Midgardian
...
- source: suggested
  ...
  rationale: 'Hybrid Strength + Intelligence — this kit scales on both (efficiency
    ...
    of Radiance, Obsidian Shard, Shifter''s Shield, Berserker''s Shield, Hydra''s
