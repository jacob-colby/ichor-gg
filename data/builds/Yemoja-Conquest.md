...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Magus, Breastplate of Valor, Void Shield, Obsidian Shard, Void Stone, Shifter''s
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Cuirass, Spear of Desolation, Breastplate of Valor, Soul Gem, Shifter''s Shield,
    ...
    Of Discord, Obsidian Shard, Chronos'' Pendant, Jade Scepter.'
  slot_scores:
    Kinetic Cuirass:
      total: 0.47
      efficiency: 0.56
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Spear of Desolation, Amanita Charm, Kinetic Cuirass, Shield of the Phoenix, Screeching
...
- source: suggested
  ...
  rationale: 'Off-type Strength build — this kit scales on it (efficiency + fit +
    ...
    Obsidian Shard, Eye of Providence, Avenging Blade, Nimble Ring, Tekko-Kagi, Stone
    of Binding, Draconic Scale, Titan''s Bane, The Crusher, Screeching Gargoyle, Pharaoh''s
