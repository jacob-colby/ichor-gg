...
- source: community
  ...
  god_win_rate: 0.5307156428119063
  god_matches_won: 838
  god_matches_played: 1579
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Blade, Avatar''s Parashu, Bracer of The Abyss, Pendulum Blade, Demon Blade, Musashi''s
    Dual Swords, The Cosmic Horror, Ancient Signet, Oath-Sworn Spear, Blood-Bound
    Book, Transcendence, Qin''s Blade, Chronos'' Pendant, Runeforged Hammer, Toxic
    Blade.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Berserker''s Shield, Bancroft''s Talon, Doom Orb, The World Stone, Toxic Blade.'
  slot_scores:
    Lernaean Bow:
      total: 0.5
      efficiency: 0.52
...
- source: suggested
  ...
  - added: Riptalon
    ...
    reason: community 61% win over 316 matches (vs 53% on this god), taking the model's
