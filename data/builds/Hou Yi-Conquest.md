...
- source: community
  ...
  god_win_rate: 0.5271049596309112
  god_matches_won: 914
  god_matches_played: 1734
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Book, Toxic Blade, Transcendence, Qin''s Blade, Chronos'' Pendant, Runeforged
    Hammer.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
...
- source: suggested
  ...
  - added: Riptalon
    ...
    reason: community 61% win over 347 matches (vs 53% on this god), taking the model's
