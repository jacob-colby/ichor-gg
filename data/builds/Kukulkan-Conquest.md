...
- source: community
  ...
  god_win_rate: 0.5647921760391198
  god_matches_won: 231
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Asclepius, Blood-Bound Book, Divine Ruin, Bancroft''s Talon, Helm of Radiance,
    Ethereal Staff, Staff of Myrddin, Wish-Granting Pearl, Typhon’s Heart, Bracer
    of The Abyss, Jade Scepter, Nimble Ring.'
  slot_scores:
    Book of Thoth:
      total: 0.53
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'mana-stack (efficiency + fit + win/pick). Underrated for this god: Soul
    ...
    Dreamer''s Idol, Bragi''s Harp, Gem of Focus, The Cosmic Horror, Rod of Asclepius,
    Bancroft''s Talon, Totem of Death, Triton''s Conch, Blood-Bound Book, Divine Ruin,
    Wish-Granting Pearl, Helm of Radiance, Breastplate of Valor, Ethereal Staff, Jade
    Scepter.'
  slot_scores:
    Book of Thoth:
      total: 0.53
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    of Death, Rod of Asclepius, Blood-Bound Book, Divine Ruin, Triton''s Conch, Breastplate
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    of Death, Blood-Bound Book, Divine Ruin, Bancroft''s Talon, Helm of Radiance,
    Ethereal Staff, Screeching Gargoyle, Wish-Granting Pearl, Typhon’s Heart, Breastplate
    of Valor, Bracer of The Abyss, Jade Scepter.'
  slot_scores:
    Book of Thoth:
      total: 0.52
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'Basic-attack DPS skew (efficiency + fit + win/pick). Underrated for
    ...
    Horror, Typhon’s Heart, Totem of Death, Divine Ruin, Helm of Radiance, Daybreak
    Gavel, Jade Scepter.'
  slot_scores:
    Bracer of The Abyss:
      total: 0.5
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Grace, Freya''s Tears, Blood-Bound Book, Jade Scepter.'
  slot_scores:
    Book of Thoth:
      total: 0.49
      efficiency: 0.51
...
- source: suggested
  ...
  rationale: 'The model''s own answer — no meta signal (efficiency + fit + win/pick).
    ...
    Death, Rod of Asclepius, Blood-Bound Book, Jade Scepter, Divine Ruin, Bancroft''s
...
- source: suggested
  ...
  - added: Polynomicon
    removed: Doom Orb
    reason: community 73% win over 61 matches (vs 56% on this god), taking the model's
