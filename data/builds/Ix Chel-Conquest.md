...
- source: community
  ...
  god_win_rate: 0.4416527079843663
  god_matches_won: 791
  god_matches_played: 1791
...
- source: suggested
  ...
  rationale: 'Ability / burst skew (efficiency + fit + win/pick). Underrated for this
    ...
    Wish-Granting Pearl, Magi''s Cloak, Daybreak Gavel, Chronos'' Pendant, Ancient
    Signet.'
  slot_scores:
    Genji's Guard:
      total: 0.48
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Prophetic Cloak, Chronos'' Pendant, Erosion, Gladiator''s Shield, Eye of Providence,
...
- source: suggested
  ...
  - added: Obsidian Shard
    ...
    reason: community 51% win over 251 matches (vs 44% on this god), taking the model's
