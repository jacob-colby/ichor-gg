...
- source: community
  ...
  god_win_rate: 0.5462555066079295
  god_matches_won: 124
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Gluttonous Grimoire, Shifter''s Shield, Chronos'' Pendant, Gem of Focus, Spear
    of the Magus, Helm of Radiance, Prophetic Cloak, Erosion, Gladiator''s Shield,
...
- source: suggested
  ...
  - added: The World Stone
    ...
    reason: community 67% win over 73 matches (vs 55% on this god), taking the model's
