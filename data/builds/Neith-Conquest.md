...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    for this god: Silverbranch Bow, Jotunn''s Revenge, Tyrfing, Soul Gem, Nimble Ring,
...
- source: suggested
  ...
  rationale: 'Off-type Intelligence build — this kit scales on it (efficiency + fit
    + win/pick). Underrated for this god: Silverbranch Bow, Jotunn''s Revenge, Tyrfing,
    Nimble Ring, Soul Gem, Death Metal, Gluttonous Grimoire, Spear of the Magus, Bragi''s
    Harp, Riptalon, Bracer of The Abyss, The Reaper, Lernaean Bow, Chronos'' Pendant,
    Hydra''s Lament, Doom Orb, Tekko-Kagi, Ancient Signet, Heartseeker, Blood-Bound
