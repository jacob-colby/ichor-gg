...
- source: community
  ...
  god_win_rate: 0.6178861788617886
  god_matches_won: 76
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Ancient Signet, Chronos'' Pendant, Sun Beam Bow, Avenging Blade.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.65
      efficiency: 0.72
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Pharaoh''s Curse, Tyrfing, Shifter''s Shield, Lernaean Bow, Phoenix Feather, Erosion,
    ...
    Chandra''s Grace, Daybreak Gavel, Avenging Blade.'
  slot_scores:
    Berserker's Shield:
      total: 0.61
      efficiency: 0.68
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Nimble Ring, Avatar''s Parashu, Dreamer''s Idol, Pendulum Blade, Golden Blade,
    Bragi''s Harp, Dominance, Deathbringer, The Cosmic Horror, Bracer of The Abyss,
    Oath-Sworn Spear, Demon Blade, Musashi''s Dual Swords, Transcendence, The Executioner,
    Avenging Blade, Runeforged Hammer, Arondight, Ancient Signet, Qin''s Blade, Chronos''
    Pendant.'
  slot_scores:
    Book of Thoth:
      total: 0.49
