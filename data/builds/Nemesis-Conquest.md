...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Berserker''s Shield, Demon Blade, Eye of the Storm, Transcendence, Pendulum Blade,
    Musashi''s Dual Swords, Spectral Armor, Pharaoh''s Curse, Arondight, Barbed Carver,
    Kinetic Cuirass, Eros'' Bow, Oath-Sworn Spear.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.54
      efficiency: 0.55
...
- source: suggested
  ...
  rationale: 'Full-penetration anti-tank skew (efficiency + fit + win/pick). Underrated
    ...
    Tyrfing, Oath-Sworn Spear, Runeforged Hammer, Lernaean Bow, Pendulum Blade, Golden
    Blade, Damaru, Screeching Gargoyle, Shield Splitter, Riptalon, Rage, Berserker''s
    Shield, Spectral Armor, Eye of the Storm, Transcendence, Kinetic Cuirass, Genji''s
    Guard, Void Stone, Eye of Providence, Pharaoh''s Curse.'
  slot_scores:
    Jotunn's Revenge:
      total: 0.56
      efficiency: 0.55
