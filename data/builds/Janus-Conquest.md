...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Lifebinder, Eye of Providence, Chandra''s Grace, Spirit Robe, Spear of the Magus,
    Genji''s Guard, Phoenix Feather, Helm of Radiance, Doom Orb, Ethereal Staff, Spectral
    Armor, Chronos'' Pendant, Glorious Pridwen, Breastplate of Valor, Ancient Signet,
