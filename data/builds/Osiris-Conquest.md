...
- source: community
  ...
  god_win_rate: 0.5044776119402985
  god_matches_won: 169
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    this god: Jotunn''s Revenge, Amanita Charm, Golden Blade, Runeforged Hammer, Kinetic
...
- source: suggested
  ...
  - added: Draconic Scale
    ...
    reason: community 69% win over 30 matches (vs 50% on this god), taking the model's
