...
- source: community
  ...
  god_win_rate: 0.4622222222222222
  god_matches_won: 104
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Screeching Gargoyle, Runeforged Hammer, Gladiator''s Shield, Spectral Armor, Damaru,
    Shogun''s Ofuda, Lernaean Bow, Arondight, Erosion, Leviathan''s Hide, Eye of the
    Storm, Eye of Providence, Yogi''s Necklace, Midgardian Mail, Dominance.'
  slot_scores:
    Genji's Guard:
      total: 0.51
      efficiency: 0.69
