...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Feather, Chandra''s Grace, Heartseeker, Avenging Blade, Spear of Desolation, Glorious
    Pridwen, Lifebinder, Spear of the Magus, Stone of Binding, Helm of Radiance, Midgardian
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Chronos'' Pendant, Shield Splitter, Runeforged Hammer, Helm of Radiance, Spear
    of the Magus, Erosion, Eye of Providence, Stone of Binding, Obsidian Shard, Eye
    of the Storm, Arondight, Gem of Focus, Magi''s Cloak, Rod of Asclepius, Glorious
    Pridwen, Eye of Erebus, Mantle Of Discord, Midgardian Mail, Daybreak Gavel, Heartseeker,
    Pendulum Blade, Chandra''s Grace, Jade Scepter, Prophetic Cloak.'
  slot_scores:
    Breastplate of Valor:
      total: 0.52
      efficiency: 0.65
