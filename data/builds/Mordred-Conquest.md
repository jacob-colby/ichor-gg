...
- source: community
  ...
  god_win_rate: 0.5175675675675676
  god_matches_won: 383
...
- source: suggested
  ...
  rationale: 'Top weighted-score core (efficiency + fit + win/pick). Underrated for
    ...
    Leviathan''s Hide, Void Shield, Stampede, Ancile, Rod of Asclepius, Oni Hunter''s
    Garb, The Reaper, Prophetic Cloak.'
  slot_scores:
    Breastplate of Valor:
      total: 0.52
      efficiency: 0.65
...
- source: suggested
  ...
  rationale: 'Lifesteal bruiser skew (efficiency + fit + win/pick). Underrated for
    ...
    Helm of Radiance, Midgardian Mail, Obsidian Shard, Titan''s Bane, Sphere of Negation,
...
- source: suggested
  ...
  rationale: 'Ability-uptime skew — Cooldown Rate is a rate, not a reduction (efficiency
    ...
    Cloak, Spear of the Magus, Erosion, Eye of Providence, Stone of Binding, Draconic
    Scale, Obsidian Shard, Eye of the Storm, Arondight, Gem of Focus, Magi''s Cloak,
    Rod of Asclepius, Eye of Erebus, Mantle Of Discord, Midgardian Mail, Heartseeker,
